...
-   获取矩阵计算结果只支持调用[IterateAll](../../../../../api/SIMD-API/高阶API/矩阵计算/Matmul-Kernel侧接口/IterateAll.md)接口输出到[GlobalTensor](../../../../../api/SIMD-API/基础API/数据结构/LocalTensor和GlobalTensor定义/GlobalTensor/GlobalTensor.md)，即计算结果放置于Global Memory的地址，不能调用[GetTensorC](../../../../../api/SIMD-API/高阶API/矩阵计算/Matmul-Kernel侧接口/GetTensorC.md)等接口获取结果。

...
2.  **设置A、B、Bias的数据类型和格式。**
    ...
    设置示例如下，关于TPosition的详细内容请参考[TPosition](../../../../../api/SIMD-API/基础API/数据结构/辅助数据结构/TPosition.md)。

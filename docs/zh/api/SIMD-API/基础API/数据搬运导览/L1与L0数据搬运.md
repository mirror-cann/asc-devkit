...
搬运的数据用于[矩阵计算](../矩阵计算（ISASI）/矩阵计算（ISASI）.md)，接口具体介绍请参考：[LoadData（2D矩阵搬运V2）](../矩阵计算（ISASI）/矩阵计算的搬入/LoadData_2D_V2.md)。
...
搬运的数据用于[矩阵计算](../矩阵计算（ISASI）/矩阵计算（ISASI）.md)，接口具体介绍请参考：[LoadData（MX矩阵搬运）](../矩阵计算（ISASI）/矩阵计算的搬入/LoadData_2D_MX.md)。
...
搬运的数据用于[矩阵计算](../矩阵计算（ISASI）/矩阵计算（ISASI）.md)，接口具体介绍请参考：[LoadDataWithTranspose](../矩阵计算（ISASI）/矩阵计算的搬入/LoadDataWithTranspose.md)。
...
搬运的数据用于[矩阵计算](../矩阵计算（ISASI）/矩阵计算（ISASI）.md)，接口具体介绍请参考：[LoadData（卷积数据搬运）](../矩阵计算（ISASI）/矩阵计算的搬入/LoadData_3D.md)。
...
搬运的数据用于[矩阵计算](../矩阵计算（ISASI）/矩阵计算（ISASI）.md)，接口具体介绍请参考：[LoadDataWithStride](../矩阵计算（ISASI）/矩阵计算的搬入/LoadDataWithStride.md)。
...
搬运的数据用于[矩阵计算](../矩阵计算（ISASI）/矩阵计算（ISASI）.md)，接口具体介绍请参考：[LoadDataWithSparse](../矩阵计算（ISASI）/矩阵计算的搬入/LoadDataWithSparse.md)。
...
搬运的数据为[矩阵计算](../矩阵计算（ISASI）/矩阵计算（ISASI）.md)的结果，接口具体介绍请参考：[DataCopy（L0C到L1数据搬运）](../矩阵计算（ISASI）/矩阵计算的搬出/DataCopy（L0C到L1数据搬运）.md)。
...
注意，不同产品型号的接口原型可能不同，具体介绍请参考：[Fixpipe（L0C到L1数据搬运）](../矩阵计算（ISASI）/矩阵计算的搬出/Fixpipe（L0C到L1数据搬运）.md)。

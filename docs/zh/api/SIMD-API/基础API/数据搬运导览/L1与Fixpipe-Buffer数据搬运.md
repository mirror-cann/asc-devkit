...
搬运的数据为[随路量化](../矩阵计算（ISASI）/矩阵计算的搬出/关键特性说明/随路量化.md)和[随路relu](../矩阵计算（ISASI）/矩阵计算的搬出/关键特性说明/随路ReLU.md)参数，接口具体介绍请参考：[L1ToFixpipe-Buffer数据搬运（DataCopy）](../矩阵计算（ISASI）/矩阵计算的搬入/矩阵数据搬入至L0-Buffer/L1ToFixpipe-Buffer数据搬运（DataCopy）.md)。

...
| NDDMA Cache | NDDMA Cache用于缓存最近或即将被[DataCopy（GMToUB多维数据搬运NDDMA）](../../基础API/Memory矢量计算/数据搬运/DataCopy（GMToUB多维数据搬运NDDMA）.md)接口搬运的数据。 |
...
| NDDMA Cache | NdDmaDci | 在使用[DataCopy（GMToUB多维数据搬运NDDMA）](../../基础API/Memory矢量计算/数据搬运/DataCopy（GMToUB多维数据搬运NDDMA）.md)接口进行数据搬运前，需要使用NdDmaDci接口刷新NDDMA Cache缓存保证为最新状态。 |

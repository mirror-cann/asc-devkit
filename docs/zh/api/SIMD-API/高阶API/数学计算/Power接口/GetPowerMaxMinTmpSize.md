...
| 参数名 | 输入/输出 | 描述 |
| --- | --- | --- |
| srcShape1 | 输入 | 输入srcTensor1的shape信息，参数类型为[AscendC::TensorShape](../../数据结构/TensorShape.md)。 |
| srcShape2 | 输入 | 输入srcTensor2的shape信息，参数类型为[AscendC::TensorShape](../../数据结构/TensorShape.md)。 |

...
L0C Buffer到Global Memory搬运涉及[随路量化](quant_pre.md)、[随路Relu](relu_pre.md)、[F32 Channel Split](f32_channel_split.md)和[Int8/Int4 Channel Merge](int8_int4_channel_merge.md)等关键特性。

...
<a name="ul146342113310"></a><a name="ul146342113310"></a><ul id="ul146342113310"><li>true：开发者允许源操作数被改写，可以启用该参数，启用后本接口内部计算时<strong id="b1161942143313"><a name="b1161942143313"></a><a name="b1161942143313"></a>复用</strong>srcTensor的内存空间，节省部分内存空间；</li><li>false：本接口内部计算时<strong id="b1684233315"><a name="b1684233315"></a><a name="b1684233315"></a>不复用</strong>srcTensor的内存空间。</li></ul>

...
<td class="cellrowborder" valign="top" width="80.82000000000001%" headers="mcps1.2.3.1.2 "><p id="p8299155010420"><a name="p8299155010420"></a><a name="p8299155010420"></a>待排序数据的数据类型。不同型号支持的数据类型请参考<a href="#li197551749192811">支持的数据类型</a>。</p>
</td>
</tr>
...
<a name="ul146342113310"></a><a name="ul146342113310"></a><ul id="ul146342113310"><li>true：开发者允许源操作数被改写，可以设置该参数取值为true开启，开启后本接口内部计算时<strong id="b1161942143313"><a name="b1161942143313"></a><a name="b1161942143313"></a>复用</strong>srcTensor的内存空间，节省部分内存空间；</li><li>false：本接口内部计算时<strong id="b1684233315"><a name="b1684233315"></a><a name="b1684233315"></a>不复用</strong>srcTensor的内存空间。</li></ul>
<p id="p1858160123013"><a name="p1858160123013"></a><a name="p1858160123013"></a><span id="ph1949522133011"><a name="ph1949522133011"></a><a name="ph1949522133011"></a><term id="zh-cn_topic_0000001312391781_term1253731311225_4"><a name="zh-cn_topic_0000001312391781_term1253731311225_4"></a><a name="zh-cn_topic_0000001312391781_term1253731311225_4"></a>Atlas A3 训练系列产品</term>/<term id="zh-cn_topic_0000001312391781_term131434243115_4"><a name="zh-cn_topic_0000001312391781_term131434243115_4"></a><a name="zh-cn_topic_0000001312391781_term131434243115_4"></a>Atlas A3 推理系列产品</term></span>，该参数预留，传入默认值false即可。</p>
<p id="p0211214415"><a name="p0211214415"></a><a name="p0211214415"></a><span id="ph12112124116"><a name="ph12112124116"></a><a name="ph12112124116"></a><term id="zh-cn_topic_0000001312391781_term11962195213215_4"><a name="zh-cn_topic_0000001312391781_term11962195213215_4"></a><a name="zh-cn_topic_0000001312391781_term11962195213215_4"></a>Atlas A2 训练系列产品</term>/<term id="zh-cn_topic_0000001312391781_term184716139811_4"><a name="zh-cn_topic_0000001312391781_term184716139811_4"></a><a name="zh-cn_topic_0000001312391781_term184716139811_4"></a>Atlas A2 推理系列产品</term></span>，该参数预留，传入默认值false即可。</p>
<p id="p12281194220419"><a name="p12281194220419"></a><a name="p12281194220419"></a><span id="ph8281194214120"><a name="ph8281194214120"></a><a name="ph8281194214120"></a><term id="zh-cn_topic_0000001312391781_term1964153212227_1"><a name="zh-cn_topic_0000001312391781_term1964153212227_1"></a><a name="zh-cn_topic_0000001312391781_term1964153212227_1"></a>Atlas 推理系列产品</term>AI Core</span>，该参数预留，传入默认值false即可。</p>
...
<td class="cellrowborder" valign="top" width="80.82000000000001%" headers="mcps1.2.3.1.2 "><p id="p397819311310"><a name="p397819311310"></a><a name="p397819311310"></a>该参数仅支持<span id="ph13438171616318"><a name="ph13438171616318"></a><a name="ph13438171616318"></a>Ascend 950PR/Ascend 950DT</span>。</p>
<p id="p4979658192614"><a name="p4979658192614"></a><a name="p4979658192614"></a>TopK计算的相关配置，包括算法选择、取最大值或最小值、是否对结果排序。此参数可选配，TopKConfig类型，具体定义如下：</p>
...
<div class="p" id="p3467144015429"><a name="p3467144015429"></a><a name="p3467144015429"></a><span id="ph1846711400423"><a name="ph1846711400423"></a><a name="ph1846711400423"></a><term id="zh-cn_topic_0000001312391781_term1964153212227_2"><a name="zh-cn_topic_0000001312391781_term1964153212227_2"></a><a name="zh-cn_topic_0000001312391781_term1964153212227_2"></a>Atlas 推理系列产品</term>AI Core</span>上：<a name="ul13318142844512"></a><a name="ul13318142844512"></a><ul id="ul13318142844512"><li>输入数据的shape为outter * inner。开发者需要为其开辟outter * inner * sizeof(T)大小的空间。</li><li>当n &lt; inner时，开发者需要对srcLocal里outter条数据进行补齐操作，每条数据都需要从n补齐到inner长度。</li><li>补齐的规则：要求填充的数据不能影响整体排序。建议使用如下的填充方法：在取前k个最大值的时候，填充的值需要是<strong id="b335492416414"><a name="b335492416414"></a><a name="b335492416414"></a>输入数据类型</strong>的最小值；在取前k个最小值的时候，填充的值需要是<strong id="b20472538044"><a name="b20472538044"></a><a name="b20472538044"></a>输入数据类型</strong>的最大值。</li></ul>
</div>
</td>
</tr>
...
<p id="p1071842161817"><a name="p1071842161817"></a><a name="p1071842161817"></a>类型为<a href="../../基础数据结构/LocalTensor/LocalTensor.md">LocalTensor</a>，支持的TPosition为VECIN/VECCALC/VECOUT。</p>
...
<p id="p5983205412394"><a name="p5983205412394"></a><a name="p5983205412394"></a>类型为<a href="../../基础数据结构/LocalTensor/LocalTensor.md">LocalTensor</a>，<strong id="b59111328115018"><a name="b59111328115018"></a><a name="b59111328115018"></a>逻辑位置仅支持VECCALC，不支持其他逻辑位置</strong>。</p>
</td>
</tr>
...
-   <a name="li197551749192811"></a>支持的数据类型

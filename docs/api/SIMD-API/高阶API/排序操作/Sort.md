...
-   对应不带SortConfig的函数原型
    ...
    **表 1**  模板参数说明
    ...
    | 参数名 | 含义 |
    | --- | --- |
    | T | 操作数的数据类型。支持的数据类型为：half、float。<br>    <br>Kirin X90，支持的数据类型为：half。<br>    <br>Kirin 9030，支持的数据类型为：half。 |

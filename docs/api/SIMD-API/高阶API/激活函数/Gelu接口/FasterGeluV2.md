...
<td class="cellrowborder" valign="top" width="80.67999999999999%" headers="mcps1.2.3.1.2 "><p id="p476991071613"><a name="p476991071613"></a><a name="p476991071613"></a>是否开启高精度模式，以提升运算准确度。默认值为false，表示不开启高精度模式。</p>

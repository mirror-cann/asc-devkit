...
<td class="cellrowborder" valign="top" width="75.59%" headers="mcps1.2.4.1.3 "><p id="p193354319434"><a name="p193354319434"></a><a name="p193354319434"></a>是否启用SoftMaxFlashV3 update为true的公式计算。该参数取值与SoftmaxFlashV3 Kernel接口的模板参数isUpdate保持一致。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="69.05%" headers="mcps1.2.4.1.3 "><p id="p1342071787"><a name="p1342071787"></a><a name="p1342071787"></a>是否启用SoftMaxFlashV3 update为true的公式计算。与SoftmaxFlashV3 Kernel接口的模板参数isUpdate保持一致。</p>
</td>
</tr>

...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="p10298195117267"><a name="p10298195117267"></a><a name="p10298195117267"></a>是否允许修改源操作数，默认值为false。如果开发者允许源操作数被改写，可以开启该参数，开启后能够节省部分内存空间。</p>
...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="p361414011277"><a name="p361414011277"></a><a name="p361414011277"></a>srcTensor的shape信息满足基本块要求的情况下，可以启用该参数用于提升性能，默认不启用。基本块要求srcTensor的shape需要满足如下条件：</p>

...
<td class="cellrowborder" valign="top" width="80.62%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001698360521_p125969172719"><a name="zh-cn_topic_0000001698360521_p125969172719"></a><a name="zh-cn_topic_0000001698360521_p125969172719"></a>操作数的数据类型。支持的数据类型为：half、float。</p>
</td>
</tr>
...
<p id="p843911117182"><a name="p843911117182"></a><a name="p843911117182"></a>true：开发者允许源操作数被改写，可以启用该参数，启用后本接口内部计算时<strong id="b68501198557"><a name="b68501198557"></a><a name="b68501198557"></a>复用</strong>srcTensor的内存空间，节省部分内存空间；</p>

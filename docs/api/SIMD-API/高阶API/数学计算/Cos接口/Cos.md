...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="p2201141412564"><a name="p2201141412564"></a><a name="p2201141412564"></a>该参数仅支持<span id="ph43655361233"><a name="ph43655361233"></a><a name="ph43655361233"></a>Ascend 950PR/Ascend 950DT</span>。</p>
<p id="p47039339417"><a name="p47039339417"></a><a name="p47039339417"></a>Cos算法的相关配置。此参数可选配，CosConfig类型，具体定义如下方代码所示，其中参数的含义为：</p>

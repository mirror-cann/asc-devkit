...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001698360521_p125969172719"><a name="zh-cn_topic_0000001698360521_p125969172719"></a><a name="zh-cn_topic_0000001698360521_p125969172719"></a>操作数的数据类型。支持的数据类型为：half、float。</p>
</td>
</tr>
...
<p id="p174768308175"><a name="p174768308175"></a><a name="p174768308175"></a>true：开发者允许源操作数被改写，可以设置该参数取值为true开启，开启后本接口内部计算时<strong id="b68501198557"><a name="b68501198557"></a><a name="b68501198557"></a>复用</strong>srcTensor的内存空间，节省部分内存空间；</p>

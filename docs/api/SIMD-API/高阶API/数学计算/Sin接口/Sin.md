...
<a name="ul1513803335520"></a><a name="ul1513803335520"></a><ul id="ul1513803335520"><li>true：开发者允许源操作数被改写，可以设置该参数取值为true开启，开启后本接口内部计算时<strong id="b68501198557"><a name="b68501198557"></a><a name="b68501198557"></a>复用</strong>srcTensor的内存空间，节省部分内存空间；</li><li>false：本接口内部计算时<strong id="b2850191935517"><a name="b2850191935517"></a><a name="b2850191935517"></a>不复用</strong>srcTensor的内存空间。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="p2201141412564"><a name="p2201141412564"></a><a name="p2201141412564"></a>该参数仅支持<span id="ph167508191538"><a name="ph167508191538"></a><a name="ph167508191538"></a>Ascend 950PR/Ascend 950DT</span>。</p>
<p id="p63862020193115"><a name="p63862020193115"></a><a name="p63862020193115"></a>Sin算法的相关配置。此参数可选配，SinConfig类型，具体定义如下方代码所示，其中参数的含义为：</p>

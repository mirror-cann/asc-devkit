...
-   Conv3dParam信息（可选），用于启用不同场景的性能优化模板。**当前暂不支持使用。**
...
<td class="cellrowborder" valign="top" width="59.18%" headers="mcps1.2.4.1.3 "><p id="p148751821131416"><a name="p148751821131416"></a><a name="p148751821131416"></a>ConvParam类型模板参数，用于启用不同场景的性能优化模板，<strong id="b1547928121812"><a name="b1547928121812"></a><a name="b1547928121812"></a>当前版本只支持基础模板，不支持性能优化。</strong></p>
</td>
</tr>
</tbody>
</table>

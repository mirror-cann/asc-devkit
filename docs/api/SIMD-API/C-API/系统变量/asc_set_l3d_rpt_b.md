...
用于设置接口[asc_copy_l12l0a](../矩阵数据搬运/asc_copy_l12l0a/asc_copy_l12l0a_arch_3510.md)、[asc_copy_l12l0b](../矩阵数据搬运/asc_copy_l12l0b/asc_copy_l12l0b_arch_3510.md)的2D格式搬运的repeat参数。
...
- 需要配合接口[asc_copy_l12l0a](../矩阵数据搬运/asc_copy_l12l0a/asc_copy_l12l0a_arch_3510.md)、[asc_copy_l12l0b](../矩阵数据搬运/asc_copy_l12l0b/asc_copy_l12l0b_arch_3510.md)使用。

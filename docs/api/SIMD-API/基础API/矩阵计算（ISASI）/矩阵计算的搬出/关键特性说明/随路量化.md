...
<!-- npu="A3,910b" id3 -->
**表1** 量化参数QUANT\_PRE比特位含义映射表（[NPU架构版本2201](https://gitcode.com/cann/asc-devkit/blob/master/docs/guide/编程指南/语言扩展层/SIMD-BuiltIn关键字.md)）<a id="zh-cn_topic_0000002547300781_table1273124313613"></a>
...
<!-- npu="950" id4 -->
**表2** 量化参数QUANT\_PRE比特位含义映射表（[NPU架构版本3510](https://gitcode.com/cann/asc-devkit/blob/master/docs/guide/编程指南/语言扩展层/SIMD-BuiltIn关键字.md)）<a id="zh-cn_topic_0000002547300781_table1273124313714"></a>

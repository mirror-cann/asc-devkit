...
| 参数名称 | 类型 | 说明 |
| --- | --- | --- |
| dst | 输出 | 目的操作数。<br><br><cann-filter npu-type = "910">Atlas 训练系列产品，支持的TPosition为：CO1，CO2</cann-filter><br><cann-filter npu-type = "310p">Atlas 推理系列产品AI Core，支持的TPosition为：CO1，CO2</cann-filter> |

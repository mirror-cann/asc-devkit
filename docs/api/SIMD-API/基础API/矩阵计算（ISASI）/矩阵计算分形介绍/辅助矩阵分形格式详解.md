...
- **MX scaleA系数矩阵分形介绍**
    ...
    - **设计原理：** MX矩阵乘法中A矩阵与scaleA矩阵物理地址上一一映射，Load2DV2MX指令要求在L1 Buffer中scaleA矩阵满足行读取需求，因此在L1 Buffer上scaleA矩阵为按行存储的小z大Z排布（Zz）。
...
具体实现可参考：[MXmmad最佳实践](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/05_best_practices/01_matrix_compute/matmul_mxfp4_basic_api_high_performance)。

...
完整样例请参考：[数据搬运随路原子操作做确定性计算的样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/03_basic_api/06_atomic/set_atomic_deterministic_computation)。

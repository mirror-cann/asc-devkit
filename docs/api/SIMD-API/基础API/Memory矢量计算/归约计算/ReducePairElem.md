...
本样例中只展示`Compute`流程中的部分代码。更多样例可参考[ReducePairElem样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/02_features/01_basic_api/01_memory_vector_compute/reduce_pair_elem)。

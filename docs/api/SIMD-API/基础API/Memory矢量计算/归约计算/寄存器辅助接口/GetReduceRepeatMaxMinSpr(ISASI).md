...
具体可参考[ReduceRepeat系列归约指令样例](https://gitcode.com/cann/asc-devkit/blob/master/examples/01_simd_cpp_api/02_features/01_basic_api/01_memory_vector_compute/whole_reduce_min_max_sum)。

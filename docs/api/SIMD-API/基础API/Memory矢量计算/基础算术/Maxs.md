...
<tr id="row1646013401419"><td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.1 "><p id="p546014407413"><a name="p546014407413"></a><a name="p546014407413"></a><span id="ph620365952710"><a name="ph620365952710"></a><a name="ph620365952710"></a>Kirin 9030</span></p>
</td>
...
- 针对Ascend 950PR/Ascend 950DT，T和U支持的数据类型为：uint8_t、int8_t、half、bfloat16_t、int16_t、float、int32_t、uint64_t、int64_t。数据类型int8_t、uint8_t、uint64_t、int64_t仅支持tensor前n个数据计算接口。

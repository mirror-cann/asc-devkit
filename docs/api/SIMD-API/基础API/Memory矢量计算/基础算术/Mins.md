...
- 针对Ascend 950PR/Ascend 950DT，T和U支持的数据类型为：int8_t、uint8_t、half、bfloat16_t、int16_t、float、int32_t、uint64_t、int64_t。数据类型int8_t、uint8_t、uint64_t、int64_t仅支持tensor前n个数据计算接口。

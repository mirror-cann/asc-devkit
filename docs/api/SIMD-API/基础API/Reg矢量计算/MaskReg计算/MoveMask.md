...
Mask与MaskReg的机制对比，具体请参考[A2/A3与950 Mask机制对比](../概述/寄存器数据类型/MaskReg.md)。
...
- 本接口为兼容性接口，建议优先采用[CreateMask接口](../概述/寄存器数据类型/MaskReg.md)和[UpdateMask接口](../概述/寄存器数据类型/MaskReg.md)进行MaskReg计算。

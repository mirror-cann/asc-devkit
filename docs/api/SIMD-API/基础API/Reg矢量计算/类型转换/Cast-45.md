...
<tr id="row7745207267"><td class="cellrowborder" valign="top" width="57.99999999999999%" headers="mcps1.1.3.1.1 "><p id="p58321000181"><a name="p58321000181"></a><a name="p58321000181"></a><span id="ph1783212018183"><a name="ph1783212018183"></a><a name="ph1783212018183"></a>BS9SX2A AI处理器</span></p>
</td>
<td class="cellrowborder" align="center" valign="top" width="42%" headers="mcps1.1.3.1.2 "><p id="p994613912181"><a name="p994613912181"></a><a name="p994613912181"></a>√</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.2.4.1.3 "><p id="p1337312597287"><a name="p1337312597287"></a><a name="p1337312597287"></a><span id="ph15776181222"><a name="ph15776181222"></a><a name="ph15776181222"></a>源操作数元素操作的有效指示，详细说明请参考<a href="../寄存器数据类型/MaskReg.md">MaskReg</a>。</span></p>
...
-   浮点数转浮点数：
    ...
    -   对于bfloat16\_t到fp4x2\_e2m1\_t/fp4x2\_e1m2\_t数据类型的转换，指令会以每2个元素为一对进行读写，mask有效位以偶数位为准，例如10 00 00 00 10 10 00 10 等效于11 11 00 00 10 10 00 11。

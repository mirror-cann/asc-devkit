...
矢量内每个元素与标量求和，计算公式如下，其中VL\_T表示矢量计算单元一个迭代能够处理的元素个数。VL\_T的取值参考[RegTensor](../寄存器数据类型/RegTensor.md)。
...
<td class="cellrowborder" valign="top" width="81.45%" headers="mcps1.2.3.1.2 "><p id="p131047476612"><a name="p131047476612"></a><a name="p131047476612"></a>dstReg为RegTensor类型， 例如RegTensor&lt;half&gt;，由编译器自动推导，用户不需要填写。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p157411581277"><a name="p157411581277"></a><a name="p157411581277"></a>类型为<a href="../寄存器数据类型/RegTensor.md">RegTensor</a>。</p>
...
<td class="cellrowborder" valign="top" width="71.41%" headers="mcps1.2.4.1.3 "><p id="p11541143920"><a name="p11541143920"></a><a name="p11541143920"></a>mask寄存器，用于指示源操作数元素操作是否有效，详细说明请参考<a href="../寄存器数据类型/MaskReg.md">MaskReg</a>。</p>
</td>
</tr>
</tbody>
</table>

...
根据mask，对输入数据srcReg0，按照srcReg1对应元素进行左移操作，并将结果写入dstReg。
...
<a name="ul1163765616511"></a><a name="ul1163765616511"></a><ul id="ul1163765616511"><li>ZEROING，mask未选中的元素在dst中置零。</li><li>MERGING，当前不支持。</li></ul>
</td>
</tr>
...
<p id="p181326485341"><a name="p181326485341"></a><a name="p181326485341"></a>类型为<a href="../寄存器数据类型/RegTensor.md">RegTensor</a>。</p>

...
<p id="p16915118595"><a name="p16915118595"></a><a name="p16915118595"></a>类型为<a href="../寄存器数据类型/RegTensor.md">RegTensor</a>。</p>
...
<td class="cellrowborder" valign="top" width="71.57%" headers="mcps1.2.4.1.3 "><p id="p18101104920154"><a name="p18101104920154"></a><a name="p18101104920154"></a>指定选择源操作数的规则：mask的比特位是1时，选取srcReg0，比特位是0时，选取srcReg1。</p>
</td>
</tr>
</tbody>
</table>

...
<td class="cellrowborder" valign="top" width="74.26257374262573%" headers="mcps1.2.4.1.3 "><p id="p14697155195612"><a name="p14697155195612"></a><a name="p14697155195612"></a>用于控制是否开启post update，<a href="../辅助数据类型/PostLiteral.md">PostLiteral</a>类型。</p>
</td>
</tr>
...
**表 3**  配合Squeeze使用，连续非对齐搬出，使用AR寄存器中有效元素个数作为存储偏移量

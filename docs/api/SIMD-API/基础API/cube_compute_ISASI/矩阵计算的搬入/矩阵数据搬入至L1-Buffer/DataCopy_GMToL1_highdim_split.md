...
注：对于连续搬运场景，推荐使用[GMToL1连续数据搬运（DataCopy）](DataCopy_GMToL1_continuous.md)。
...
针对连续搬运场景，推荐使用[GMToL1连续数据搬运（DataCopy）](DataCopy_GMToL1_continuous.md)，以下示例仅展示高维切分数据搬运接口具有连续搬运能力。

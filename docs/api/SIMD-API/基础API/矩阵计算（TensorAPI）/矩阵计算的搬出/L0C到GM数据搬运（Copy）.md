...
L0C Buffer到Global Memory搬运涉及[随路量化](关键特性说明/quant_pre.md)、[随路Relu](关键特性说明/relu_pre.md)、[F32 Channel Split](关键特性说明/f32_channel_split.md)和[Int8 Channel Merge](关键特性说明/int8_channel_merge.md)等关键特性。

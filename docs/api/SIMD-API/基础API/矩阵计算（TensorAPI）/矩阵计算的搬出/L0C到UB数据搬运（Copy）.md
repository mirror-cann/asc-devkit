...
L0C Buffer到Unified Buffer搬运涉及[随路量化](关键特性说明/quant_pre.md)、[随路Relu](关键特性说明/relu_pre.md)、[Int8 Channel Merge](关键特性说明/int8_channel_merge.md)、[L0C Buffer到Unified Buffer双目标模式](关键特性说明/l0c_to_ub_dual_dst.md)等关键特性。

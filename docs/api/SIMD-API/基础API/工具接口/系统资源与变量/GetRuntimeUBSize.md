...
本调用示例通过`GetRuntimeUBSize`获取的UB空间大小，来计算tileNum的值。完整的算子样例参考：[get\_ub\_size样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/03_basic_api/09_utils/get_ub_size)。

...
在[Tiling下沉](https://gitcode.com/cann/asc-devkit/blob/9.1.0/docs/guide/编程指南/高级编程/算子入图开发/开启Tiling下沉.md)场景中，该宏定义用于生成Tiling下沉的注册类，再通过调用注册类的成员函数来注册需要下沉的Tiling函数。

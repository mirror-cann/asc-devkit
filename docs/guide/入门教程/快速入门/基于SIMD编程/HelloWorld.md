...
开始前请参考[环境准备](../../环境准备.md)安装所需的CANN软件包，完整样例请参考[hello\_world](https://gitcode.com/cann/asc-devkit/blob/9.1.0/examples/01_simd_cpp_api/00_introduction/00_quickstart/hello_world/README.md)。

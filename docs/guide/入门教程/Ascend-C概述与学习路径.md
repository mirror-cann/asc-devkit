...
- **编程模型**
   ...
   - **SIMT编程**：[Ascend C SIMT编程模型](../编程指南/编程模型/AI-Core-SIMT编程/AI-Core-SIMT编程.md)
   - [语言扩展层概述](../编程指南/语言扩展层/SIMD-BuiltIn关键字.md)
- **构建与运行**：
   - [编译与运行](../编程指南/编译与运行/编译与运行.md)
- **调试与调优**
   - [调试概述](../编程指南/调试调优/概述.md)
   - 功能调试：基本调试（print/DumpTensor）、仿真调试、上板调试
   - 性能调试：
       - [上板性能测试](../编程指南/调试调优/性能调优.md)
       - [仿真性能测试](../编程指南/调试调优/性能调优.md)
- **算子部署**：
...
- [Ascend C API参考（含每个API的规格与约束）](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0003.html)

...
- **算子部署**：
   - [PyTorch框架适配](../编程指南/高级编程/AI框架算子适配/PyTorch框架.md)
- **实践巩固**
...
- **高级编程**
   ...
   - [高级AI Core编程模型](../编程指南/高级编程/高级AI-Core编程模型/SIMD与SIMT混合编程/概述.md)
        - [SIMD & SIMT混合编程](../编程指南/高级编程/高级AI-Core编程模型/SIMD与SIMT混合编程/概述.md)

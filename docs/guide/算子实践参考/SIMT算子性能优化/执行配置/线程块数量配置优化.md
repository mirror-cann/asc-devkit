...
本优化方法对应的样例请参见[核函数的启动配置性能调优样例](https://gitcode.com/cann/asc-devkit/blob/master/examples/03_simt_api/03_best_practices/01_execution_conf_optimizations/grid_dim_config/README.md)。

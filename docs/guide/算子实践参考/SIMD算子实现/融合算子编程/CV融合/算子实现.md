...
>        ```
>    - 若算子工程不是[自定义算子工程](../../../../编程指南/高级编程/Aclnn算子工程化开发/概述.md)，也不是带有[HAVE\_WORKSPACE](../../../../编程指南/附录/基于样例工程完成Kernel直调.md#table481718169817)编译宏的Kernel直调算子工程，kernel侧需要在Matmul初始化前，通过[SetSysWorkSpace](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0171.html)设置系统workspace。
>        ```

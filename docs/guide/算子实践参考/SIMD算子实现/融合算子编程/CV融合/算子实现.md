...
根据上述分析，明确实现过程中会使用到[Matmul高阶API](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0613.html)接口，[LeakyRelu Vector计算接口](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0060.html)、[DataCopy](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0101.html)、[EnQue](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0140.html)、[DeQue](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0141.html)接口。
...
2.  **设置A、B、Bias的数据类型和格式。**
    ...
    设置示例如下，关于TPosition的详细内容请参考[TPosition](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0174.html)。
...
>- 特别的对于多核场景，需要通过[SetDim](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0693.html)接口设置Matmul计算所用的核数，MIX模式（包含矩阵计算和矢量计算）的设置规则如下：
...
>    - 在host侧Tiling实现时，设置总的workspace的数值大小（包含用户workspace和系统workspace），workspace空间由框架来申请并管理。系统workspace的空间大小通过[GetLibApiWorkSpaceSize](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_1036.html)获取。
>        ```
>        size_t userWorkspaceSize = 0;
>        size_t systemWorkspaceSize = ascendcPlatform.GetLibApiWorkSpaceSize();
>        size_t workspaceSize = userWorkspaceSize + systemWorkspaceSize;
>        ```
>    - 若算子工程不是[自定义算子工程](../../../../编程指南/高级编程/高级特性/Aclnn算子工程化开发/概述.md)，也不是带有[HAVE\_WORKSPACE](../../../../编程指南/附录/基于样例工程完成Kernel直调.md#table481718169817)编译宏的Kernel直调算子工程，kernel侧需要在Matmul初始化前，通过[SetSysWorkSpace](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0171.html)设置系统workspace。
>        ```
...
>    - 使用[设置Kernel类型接口](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0218.html)设置Kernel类型为KERNEL\_TYPE\_MIX\_xxx，同时启用AIV核和AIC核。
>    ```
...
>    } 
>    ```
>    完整样例请参考[BareMix样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.2/examples/01_simd_cpp_api/03_libraries/00_matrix/matmul_fused_mannul)。

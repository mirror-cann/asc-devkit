...
开启DoubleBuffer，参考[InitBuffer接口函数原型](https://gitcode.com/cann/asc-devkit/blob/master/docs/api/SIMD-API/基础API/资源管理/Pipe和Que框架/TPipe/InitBuffer.md)，将num参数配置成2，即BUFFER\_NUM。

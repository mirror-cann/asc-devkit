...
完整的算子样例请参考[matmul\_nd\_align算子样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.3/examples/01_simd_cpp_api/03_libraries/00_matrix/matmul_format_nd_align)。

...
完整的算子样例请参考[自定义数据来源为GM的TSCM输入的Matmul算子样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.2/examples/01_simd_cpp_api/03_libraries/00_matrix/matmul_tscm)。

...
| 优化建议 | 样例 |
| --- | --- |
| [通过SIMT实现分支判断](./计算优化/通过SIMT实现分支判断.md) | [simt_and_simd_high_performance](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/05_best_practices/08_simd_simt_hybrid/simt_and_simd_high_performance) |

表2 内存访问优化建议总览表

| 优化建议 | 样例 |
| --- | --- |
| [使用Unified Buffer提升内存访问效率](./内存访问/使用Unified-Buffer提升内存访问效率.md) | [simt_and_simd_high_performance](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/05_best_practices/08_simd_simt_hybrid/simt_and_simd_high_performance) |
| [访存合并](../SIMT算子性能优化/内存访问/访存合并.md) | [simt_and_simd_matrix_transpose](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/05_best_practices/08_simd_simt_hybrid/simt_and_simd_matrix_transpose) |

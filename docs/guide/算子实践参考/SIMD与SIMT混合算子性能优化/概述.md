...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="4">内存访问优化</td>
      <td><a href="./内存访问/使用Unified-Buffer提升内存访问效率.md">使用Unified Buffer提升内存访问效率</a></td>
      <td><a href="https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/04_best_practices/03_fusion_compute_practices/simt_and_simd_high_performance">simt_and_simd_high_performance</a></td>
    </tr>
    <tr>
      <td><a href="../SIMT算子性能优化/内存访问/DCache访问优化.md">DCache访问优化</a></td>
      <td><a href="https://gitcode.com/cann/asc-devkit/tree/master/examples/03_simt_api/03_best_practices/00_memory_optimizations/cache_hint">cache_hint</a></td>
    </tr>
    <tr>
      <td><a href="../SIMT算子性能优化/内存访问/访存合并.md">访存合并</a></td>
      <td><a href="https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/04_best_practices/03_fusion_compute_practices/matrix_transpose">matrix_transpose</a></td>
    </tr>
    <tr>
      <td><a href="../SIMT算子性能优化/内存访问/避免UB的Bank冲突.md">避免UB的Bank冲突</a></td>
      <td><a href="https://gitcode.com/cann/asc-devkit/tree/master/examples/03_simt_api/03_best_practices/00_memory_optimizations/matrix_transpose_practice">matrix_transpose_practice</a></td>
    </tr>
  </tbody>
</table>

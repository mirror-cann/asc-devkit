...
-   开启UnitFlag的约束条件
    ...
    -   开启UnitFlag功能时，若同时开启[L0C累加](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0638.html)功能，不支持多次[Iterate](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0638.html)计算、一次[GetTensorC](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta2/API/ascendcopapi/atlasascendc_api_07_0639.html)输出。
...
Matmul API开启UnitFlag功能的完整样例请参考[开启UnitFlag功能和MDL模板的Mamtul样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.2/examples/01_simd_cpp_api/03_libraries/00_matrix/matmul_unitflag)。开启UnitFlag功能的主要步骤如下：

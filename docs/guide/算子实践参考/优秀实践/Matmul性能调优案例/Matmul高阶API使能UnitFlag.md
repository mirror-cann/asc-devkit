...
Matmul API开启UnitFlag功能的完整样例请参考[开启UnitFlag功能和MDL模板的Matmul样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/03_libraries/00_matrix/matmul_unitflag)。开启UnitFlag功能的主要步骤如下：

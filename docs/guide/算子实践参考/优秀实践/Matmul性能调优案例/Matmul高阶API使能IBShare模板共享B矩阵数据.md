...
Matmul API开启IBShare模板共享B矩阵的完整样例请参考[仅B矩阵开启IBShare样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/03_libraries/00_matrix/matmul_ibshareB)。开启IBShare功能的主要步骤如下：

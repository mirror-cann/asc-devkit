...
Matmul API开启纯Cube模式的完整样例请参考[纯Cube模式的Matmul样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.2/examples/01_simd_cpp_api/03_libraries/00_matrix/matmul)。开启纯Cube模式的主要步骤如下：

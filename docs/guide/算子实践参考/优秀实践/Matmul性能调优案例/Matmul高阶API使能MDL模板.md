...
Matmul API开启MDL模板的完整样例请参考[开启UnitFlag功能和MDL模板的Mamtul样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.2/examples/01_simd_cpp_api/03_libraries/00_matrix/matmul_unitflag)。开启MDL模板的主要步骤如下：

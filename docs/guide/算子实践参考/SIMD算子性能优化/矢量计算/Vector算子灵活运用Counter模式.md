...
以下反例和正例中的代码均以[AddCustom](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.3/examples/01_simd_cpp_api/02_features/00_compilation/custom_op)算子为例，修改其中Add接口的调用代码，以说明Counter模式的优势。

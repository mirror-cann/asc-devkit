...
DataCopy接口在Ascend 950PR/Ascend 950DT上支持多维数据的搬运，具体可参考[多维数据搬运（ISASI）](https://gitcode.com/cann/asc-devkit/blob/9.1.0/docs/api/SIMD-API/基础API/Memory矢量计算/数据搬运/GM与UB数据搬运/GMToUB多维数据搬运NDDMA(D

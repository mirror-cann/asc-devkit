...
DataCopy接口在Ascend 950PR/Ascend 950DT上支持多维数据的搬运，具体可参考[多维数据搬运（ISASI）](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta3/API/ascendcopapi/atlasascendc_api_07_00131.html)。以2D场景的搬运为例，代码如下：

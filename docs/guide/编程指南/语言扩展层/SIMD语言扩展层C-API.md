...
包含asc\_simd.h文件来调用C API相应接口。如无特殊说明，包含该头文件即可满足接口调用需求。若[API文档](https://gitcode.com/cann/asc-devkit/blob/master/docs/api/SIMD-API/C-API.md)中有特殊说明，则应遵循API的具体说明。

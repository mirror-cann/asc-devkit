...
[msProf工具](https://hiascend.com/document/redirect/CannCommercialToolOpDev)包含msprof op和msprof op simulator两种使用方式，协助用户定位算子内存、算子代码以及算子指令的异常，实现全方位的算子调优。两种使用方式的详细说明请参考表1。
...
更多详细的信息可以参考[《算子开发工具用户指南》](https://hiascend.com/document/redirect/CannCommercialToolOpDev)中的“算子调优(msOpProf)”章节。

...
[msOpProf工具](https://hiascend.com/document/redirect/CannCommercialToolOpDev)包含msopprof和msopprof simulator两种使用方式，协助用户定位算子内存、算子代码以及算子指令的异常，实现全方位的算子调优。两种使用方式的详细说明请参考表1。

...
本节以[gather & adds混合编程样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/00_introduction/03_fusion_operation/gather_adds_simt_simd_hybrid)为例，展示SIMD与SIMT混合编程的关键语法。

...
本节以[gather & adds混合编程样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0/examples/05_simd_simt_hybrid/00_introduction/simd_simt_gather_and_adds)为例，展示SIMD与SIMT混合编程的关键语法。

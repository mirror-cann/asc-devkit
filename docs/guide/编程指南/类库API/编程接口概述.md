...
>[!NOTE]说明 
>本章提供编程API的概述。具体API参考见[Ascend C API](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta3/API/ascendcopapi/atlasascendc_api_07_0003.html)。

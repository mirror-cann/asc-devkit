...
2.  编写测试代码。
    ...
    -   通过OpTilingRegistry的[LoadTilingLibrary](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta3/API/ascendcopapi/atlasascendc_api_07_00075.html)接口加载Tiling动态库；使用[GetTilingFunc](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta3/API/ascendcopapi/atlasascendc_api_07_00074.html)接口获取Tiling函数指针。
    -   执行Tiling函数，验证其正确性。

...
-   kernel直调
    -   参考[ListTensorDesc](https://gitcode.com/cann/asc-devkit/blob/master/docs/api/context/ListTensorDesc.md)数据结构自行定义ListTensorDesc和TensorDesc结构体，并将实际的输入数据保存至ListTensorDesc结构中。示例如下:

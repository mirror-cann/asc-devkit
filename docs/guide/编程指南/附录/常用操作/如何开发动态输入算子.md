...
>[!NOTE]说明 
>下文仅列出代码片段，完整样例请参考[动态输入算子样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0/examples/01_simd_cpp_api/03_basic_api/04_memory_management/list_tensor_desc_input)。

-   kernel直调
    -   参考[ListTensorDesc](https://gitcode.com/cann/asc-devkit/blob/9.1.0/docs/api/SIMD-API/基础API/数据结构/辅助数据结构/ListTensorDesc.md)数据结构自行定义ListTensorDesc和TensorDesc结构体，并将实际的输入数据保存至ListTensorDesc结构中。示例如下:

...
核函数的实现参考如下代码。完整的样例请参考[简单gather算子样例](https://gitcode.com/cann/asc-devkit/tree/9.1.0-beta.3/examples/03_simt_api/02_features/00_resource_management/basic_gather)。

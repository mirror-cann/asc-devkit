...
Reg矢量计算API操作的基础数据类型介绍如下，具体API请参考[Reg矢量计算](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta3/API/ascendcopapi/atlasascendc_api_07_0311.html)。

...
-   [编程指南](编程指南/本文档组织结构.md)
    ...
    -   [编程模型](编程指南/编程模型/编程模型.md)
        ...
        -   [AI Core SIMD编程](编程指南/编程模型/AI-Core-SIMD编程/AI-Core-SIMD编程.md)
            ...
            -   [SIMD编程](编程指南/编程模型/AI-Core-SIMD编程/SIMD编程/SIMD编程.md)
    ...
    -   [硬件实现](编程指南/硬件实现/硬件实现.md)
        -   [基本架构](编程指南/硬件实现/基本架构.md)
        -   [架构规格](编程指南/硬件实现/架构规格/架构规格.md)
    ...
    -   [附录](编程指南/附录/CPP标准支持/概述.md)
        -   [C++标准支持](编程指南/附录/CPP标准支持/概述.md)
            -   [概述](编程指南/附录/CPP标准支持/概述.md)
            -   [Device侧C/C++语法限制](编程指南/附录/CPP标准支持/语法限制/语法限制.md)
                -   [特性](编程指南/附录/CPP标准支持/语法限制/特性.md)
                -   [函数](编程指南/附录/CPP标准支持/语法限制/函数.md)

        -   [工程化算子开发](编程指南/附录/工程化算子开发/工程化算子开发.md)
    ...
    -   [SIMD算子性能优化](算子实践参考/SIMD算子性能优化/SIMD算子性能优化.md)
        ...
        -   [内存访问](算子实践参考/SIMD算子性能优化/内存访问/内存访问.md)
            ...
            -   [避免UB的bank冲突](算子实践参考/SIMD算子性能优化/内存访问/避免UB的bank冲突/避免UB的bank冲突.md)
                ...
                -   [避免bank冲突（Atlas 350 加速卡）](算子实践参考/SIMD算子性能优化/内存访问/避免UB的bank冲突/避免bank冲突（Atlas-350-加速卡）.md)

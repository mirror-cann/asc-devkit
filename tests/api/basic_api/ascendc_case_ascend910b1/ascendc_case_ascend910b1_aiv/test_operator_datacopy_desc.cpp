...
private:
    __aicore__ inline void CopyND2NZ(
        const LocalTensor<SelfTensorDesc<half>>& dst, const GlobalTensor<SelfTensorDesc<half>>& src,
...
INSTANTIATE_TEST_CASE_P(
    TEST_OPEARATION_DATACOPYUb2GmNz2Nd, DataCopyDescUb2GmNz2NdTestsuite,
    ::testing::Values(
...
class DataCopyDescUb2GmNz2NdTestsuiteCheckGmOverflow
    : public testing::Test,
      public testing::WithParamInterface<DataCopyUb2GmNz2NdTestParams> {
protected:
    void SetUp() { g_coreType = AIV_TYPE; }
...
INSTANTIATE_TEST_CASE_P(
    TEST_OPEARATION_DATACOPYUb2GmNz2Nd_OOM, DataCopyDescUb2GmNz2NdTestsuiteCheckGmOverflow,
    ::testing::Values(
        DataCopyUb2GmNz2NdTestParams{2, MainDataCopyUb2GmNz2Nd<half>, {1, 32, 32, 1, 32, 32, 1}},
        DataCopyUb2GmNz2NdTestParams{2, MainDataCopyUb2GmNz2Nd<half>, {1, 64, 32, 1, 64, 32, 1}}));

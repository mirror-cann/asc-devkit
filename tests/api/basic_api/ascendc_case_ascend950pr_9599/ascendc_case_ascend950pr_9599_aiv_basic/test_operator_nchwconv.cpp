...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        // TensorTrait
        NchwconvTestParams{256, 2, false, false, 1, 16, 16, MainNchwconv<TensorTrait<half>>, 16},
        NchwconvTestParams{512, 2, false, false, 2, 16, 16, MainNchwconv<TensorTrait<uint16_t>>, 16},
        NchwconvTestParams{512, 2, false, false, 2, 1, 1, MainNchwconv<TensorTrait<int16_t>>, 32},
        NchwconvTestParams{512, 1, true, true, 1, 16, 16, MainNchwconv<TensorTrait<int8_t>>, 32},
        NchwconvTestParams{512, 1, true, false, 1, 16, 16, MainNchwconv<TensorTrait<int8_t>>, 32},
        NchwconvTestParams{1024, 1, false, false, 2, 16, 16, MainNchwconv<TensorTrait<uint8_t>>, 32},
        NchwconvTestParams{1024, 1, false, true, 2, 1, 1, MainNchwconv<TensorTrait<uint8_t>>, 64}));

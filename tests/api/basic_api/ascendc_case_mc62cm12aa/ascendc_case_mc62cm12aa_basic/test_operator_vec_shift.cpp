...
public:
        ...
        uint64_t maskBitHigh, uint64_t maskBitLow, uint8_t repeatTimes, BinaryRepeatParams& repeatParams)
    {
        ...
        src1_global.SetGlobalBuffer(reinterpret_cast<__gm__ src1Type*>(src1_gm), stackSize);
...
private:
    ...
    GlobalTensor<src1Type> src1_global;
...
protected:
    static void SetUpTestCase() { std::cout << "VecShiftTestSuite SetUpTestCase" << std::endl; }
    static void TearDownTestCase() { std::cout << "VecShiftTestSuite TearDownTestCase" << std::endl; }
    virtual void SetUp() {}
...
#define REGISTER_VEC_SHIFT_NO_MOCKER_B64(cmdKey, cmdKeyLower, dtype, dtype1, dtypeKey, dataLength)               \
    ...
    {                                                                                                            \
        ...
        main_Vec_Binary_test<dtype, dtype1, OpType::cmdKey>(                                                     \

        ...
        if constexpr (IsSameType<X_T, bfloat16_t>::value) {
            ...
            if constexpr (maskMode == 0) {
                ...
                if constexpr (maskLen == 1) {
                    ...
                    ComputeBf16CounterMasksIsSetMaskFalse();
                }
            }
        } else {
            // Normal mode
...
private:
    ...
    __aicore__ inline void ComputeBf16NormalBitIsSetMaskTrue()
    {
        ...
        uint64_t maskList[2] = {0xffffffffffffffff, 0xffffffffffffffff};
    ...
    __aicore__ inline void ComputeBf16NormalBitIsSetMaskFalse()
    {
        ...
        SetMaskNorm();
        SetVectorMask<X_T, MaskMode::NORMAL>(0xffffffffffffffff, 0xffffffffffffffff);
    ...
    __aicore__ inline void ComputeBf16NormalContinuousIsSetMaskTrue()
    {
        ...
        uint8_t repeat = sizeof(X_T);
        CopyRepeatParams repeatParams(1, 1, 8, 8);
        Copy<X_T, true>(dstLocal, srcLocal, 256, repeat, repeatParams);
        outQueueZ.EnQue<X_T>(dstLocal);
        inQueueX.FreeTensor(srcLocal);
    }
    __aicore__ inline void ComputeBf16NormalContinuousIsSetMaskFalse()
    {
        ...
        CopyRepeatParams repeatParams(1, 1, 8, 8);
        SetMaskNorm();
        SetVectorMask<X_T, MaskMode::NORMAL>(256);
    ...
    __aicore__ inline void ComputeBf16CounterMaskIsSetMaskFalse()
    {
        ...
        CopyRepeatParams repeatParams(1, 1, 8, 8);
        SetMaskCount();
        SetVectorMask<X_T, MaskMode::COUNTER>(256);
        Copy<X_T, false>(dstLocal, srcLocal, mask, repeat, repeatParams);
        SetMaskNorm();
        outQueueZ.EnQue<X_T>(dstLocal);
        inQueueX.FreeTensor(srcLocal);
    ...
    __aicore__ inline void ComputeBf16CounterMasksIsSetMaskFalse()
    {
        ...
        CopyRepeatParams repeatParams(1, 1, 8, 8);
        SetMaskCount();
        SetVectorMask<X_T, MaskMode::COUNTER>(0, 256);
        Copy<X_T, false>(dstLocal, srcLocal, mask, repeat, repeatParams);
        SetMaskNorm();
        outQueueZ.EnQue<X_T>(dstLocal);
        inQueueX.FreeTensor(srcLocal);
...
KERNEL_COPY_V300(uint16_t, 0, 0, 0, 2, 0)
KERNEL_COPY_V300(int32_t, 0, 0, 0, 2, 0)
KERNEL_COPY_V300(uint32_t, 0, 0, 0, 2, 0)
KERNEL_COPY_V300(float, 0, 0, 0, 2, 0)
KERNEL_COPY_V300(half, 0, 0, 0, 2, 0)
KERNEL_COPY_V300(bfloat16_t, 0, 0, 0, 2, 0)

KERNEL_COPY_V300(int16_t, 1, 0, 0, 2, 0)
KERNEL_COPY_V300(uint16_t, 1, 0, 0, 2, 0)
KERNEL_COPY_V300(int32_t, 1, 0, 0, 2, 0)
KERNEL_COPY_V300(uint32_t, 1, 0, 0, 2, 0)
KERNEL_COPY_V300(float, 1, 0, 0, 2, 0)
KERNEL_COPY_V300(half, 1, 0, 0, 2, 0)
KERNEL_COPY_V300(bfloat16_t, 1, 0, 0, 2, 0)

KERNEL_COPY_V300(int16_t, 0, 0, 1, 1, 40)
KERNEL_COPY_V300(uint16_t, 0, 0, 1, 1, 100)
KERNEL_COPY_V300(int32_t, 0, 0, 1, 1, 121)
KERNEL_COPY_V300(uint32_t, 0, 0, 1, 1, 200)
KERNEL_COPY_V300(float, 0, 0, 1, 1, 158)
KERNEL_COPY_V300(half, 0, 0, 1, 1, 39)
KERNEL_COPY_V300(bfloat16_t, 0, 0, 1, 1, 39)

KERNEL_COPY_V300(int16_t, 1, 0, 1, 1, 80)
KERNEL_COPY_V300(uint16_t, 1, 0, 1, 1, 123)
KERNEL_COPY_V300(int32_t, 1, 0, 1, 1, 61)
KERNEL_COPY_V300(uint32_t, 1, 0, 1, 1, 63)
KERNEL_COPY_V300(float, 1, 0, 1, 1, 50)
KERNEL_COPY_V300(half, 1, 0, 1, 1, 68)
KERNEL_COPY_V300(bfloat16_t, 1, 0, 1, 1, 68)

KERNEL_COPY_V300(int16_t, 0, 1, 1, 1, 92)
KERNEL_COPY_V300(uint16_t, 0, 1, 1, 1, 89)
KERNEL_COPY_V300(int32_t, 0, 1, 1, 1, 249)
KERNEL_COPY_V300(uint32_t, 0, 1, 1, 1, 201)
KERNEL_COPY_V300(float, 0, 1, 1, 1, 157)
KERNEL_COPY_V300(half, 0, 1, 1, 1, 132)
KERNEL_COPY_V300(bfloat16_t, 0, 1, 1, 1, 132)

KERNEL_COPY_V300(int16_t, 1, 0, 1, 1, 123)
KERNEL_COPY_V300(uint16_t, 1, 0, 1, 1, 104)
KERNEL_COPY_V300(int32_t, 1, 0, 1, 1, 48)
KERNEL_COPY_V300(uint32_t, 1, 0, 1, 1, 32)
KERNEL_COPY_V300(float, 1, 0, 1, 1, 55)
KERNEL_COPY_V300(half, 1, 0, 1, 1, 101)
KERNEL_COPY_V300(bfloat16_t, 1, 0, 1, 1, 101)

KERNEL_COPY_V300(int16_t, 0, 1, 1, 2, 199)
KERNEL_COPY_V300(uint16_t, 0, 1, 1, 2, 187)
KERNEL_COPY_V300(int32_t, 0, 1, 1, 2, 136)
KERNEL_COPY_V300(uint32_t, 0, 1, 1, 2, 144)
KERNEL_COPY_V300(float, 0, 1, 1, 2, 243)
KERNEL_COPY_V300(half, 0, 1, 1, 2, 205)
KERNEL_COPY_V300(bfloat16_t, 0, 1, 1, 2, 205)

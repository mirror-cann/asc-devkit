...
public:
    ...
    {
        pipe.InitBuffer(
            leftMatrix, 1, MATMUL_MODULE(MatmulShapeInfo)->GetOrgKa() * MATMUL_MODULE(MatmulShapeInfo)->GetOrgM());
        pipe.InitBuffer(
            rightMatrix, 1, MATMUL_MODULE(MatmulShapeInfo)->GetOrgKb() * MATMUL_MODULE(MatmulShapeInfo)->GetOrgN());
    ...
    void RunCase(
        int32_t curRow, int32_t curCol, int32_t tileHeight, int32_t tileWidth, bool isTransposeA = false,
        bool isTransposeB = false, bool isUBIn = false)
    {
...
class TestCopyCubeInNorm310P : public testing::Test {
protected:
    void SetUp() {}
    void TearDown() {}
...
private:
    ...
    MatmulImpl<
        A_TYPE_ND, B_TYPE, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm;
    // Copy_GM_NZ_Half_NoTrans
    MatmulImpl<
        A_TYPE_NZ, B_TYPE, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm2;
    // Copy_GM_VECTOR_Half_NoTrans
    MatmulImpl<
        A_TYPE_VECTOR, B_TYPE, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm3;

    // Copy_UB_ND_Half_NoTrans
    MatmulImpl<
        A_TYPE_UB_ND, B_TYPE, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm4;
    // Copy_UB_NZ_Half_NoTrans
    MatmulImpl<
        A_TYPE_UB_NZ, B_TYPE, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm5;
    // Copy_UB_VECTOR_Half_NoTrans
    MatmulImpl<
        A_TYPE_UB_VECTOR, B_TYPE, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm6;

    // Copy_B_Int8_No_Trans
    MatmulImpl<
        A_TYPE_INT8_NOTRANS, B_TYPE_INT8_NOTRANS, C_TYPE, BIAS_TYPE, CFG_NORM,
        MatmulCallBackFunc<nullptr, nullptr, nullptr>, CustomMatmulPolicy>
        mm_b_int8_no_trans;
    // Copy_A16W8
    MatmulImpl<
        A_TYPE_ND, B_TYPE_INT8_NOTRANS, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm_a16w8;
};

TEST_F(TestCopyCubeInNorm310P, Copy_GM_ND_Half_NoTrans)
{
...
TEST_F(TestCopyCubeInNorm310P, Copy_GM_NZ_Half_NoTrans)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
...
TEST_F(TestCopyCubeInNorm310P, Copy_GM_VECTOR_Half_NoTrans)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
...
TEST_F(TestCopyCubeInNorm310P, Copy_UB_ND_Half_NoTrans)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
...
TEST_F(TestCopyCubeInNorm310P, Copy_UB_NZ_Half_NoTrans)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
...
TEST_F(TestCopyCubeInNorm310P, Copy_UB_VECTOR_Half_NoTrans)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
...
TEST_F(TestCopyCubeInNorm310P, Copy_B_Int8_No_Trans)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};

...
class TestCopyCubeInNorm : public testing::Test {
protected:
    void SetUp() {}
    void TearDown() {}
...
private:
    ...
    using A_TYPE_L1 = MatmulType<AscendC::TPosition::TSCM, CubeFormat::ND, half, true>;
    ...
    MatmulImpl<
        ...
        mm3;
    MatmulImpl<
        A_TYPE_INT8, B_TYPE, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm4;
    MatmulImpl<
        ...
        mm5;
    MatmulImpl<
        A_TYPE_TRANS, B_TYPE, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm6;
    MatmulImpl<
        A_TYPE_L1, B_TYPE, C_TYPE, BIAS_TYPE, CFG_NORM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm7;
};

TEST_F(TestCopyCubeInNorm, Copy_ND_From_GM)
{
...
TEST_F(TestCopyCubeInNorm, Copy_Vector_From_GM)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
...
TEST_F(TestCopyCubeInNorm, Copy_NZ_From_GM)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
...
TEST_F(TestCopyCubeInNorm, Copy_ND_From_UB)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
...
TEST_F(TestCopyCubeInNorm, Copy_Int8_ND_From_GM)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
...
TEST_F(TestCopyCubeInNorm, Copy_ND_TRANS_From_GM)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
    ...
    tilingParams.GetTiling(tiling);
    mm6.InitVar(tiling);
    mm6.SetRuntimeParams(32, 64, true);
    mm6.RunCase(0, 0, 32, 64);
}

TEST_F(TestCopyCubeInNorm, Copy_ND_From_L1)
{
    // coreNum, M, N, K, singleCoreM, singleCoreN, singleCoreK, baseM, baseN, baseK, depthA1, depthB1, stepM, stepN,
    // stepKa, stepKb, isBias, iterateOrder
    TilingParams tilingParams = {1, 64, 256, 256, 64, 256, 256, 32, 64, 256, 2, 4, 1, 2, 1, 1, 1, 1};
    ...
    tilingParams.GetTiling(tiling);
    mm7.InitVar(tiling);
    mm7.SetRuntimeParams(32, 64, true);
    mm7.RunCase(0, 0, 32, 64);
}

...
#include "impl/adv_api/detail/matmul/scheduler/iterator/n_loop/n_loop_batch_db.h"
...
class TestNLoopBatchDB : public testing::Test {
protected:
    void SetUp() {}
    void TearDown() {}
...
TEST_F(TestNLoopBatchDB, batch_n_loop)
{
...
TEST_F(TestNLoopBatchDB, batch_n_loop_case2)
{
...
TEST_F(TestNLoopBatchDB, batch_n_loop_inner_case1)
{

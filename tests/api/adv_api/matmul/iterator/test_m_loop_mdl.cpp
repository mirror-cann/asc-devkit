...
/*!
 * \file test_m_loop_mdl.cpp
 * \brief m loop ut for mdl
 */
...
class TestMLoopMDL : public testing::Test {
protected:
    void SetUp() {}
    void TearDown() {}
...
TEST_F(TestMLoopMDL, first_iter)
{
    // Input: singleCoreM = 1793(128*14=1792), baseM = 128, stepM = 4
    // --------------------------------------------------------------

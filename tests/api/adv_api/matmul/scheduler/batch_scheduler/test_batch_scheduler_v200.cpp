...
class TestBatchSchedulerV200 : public testing::Test {
protected:
    void SetUp() {}
    void TearDown() {}
...
TEST_F(TestBatchSchedulerV200, Schedule_ComputeMultiIter)
{
...
TEST_F(TestBatchSchedulerV200, Schedule_ComputeOneIter)
{

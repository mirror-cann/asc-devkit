...
private:
    ...
    constexpr static MatmulFuncParams preloadNfuncParams{
        false, false, false, false, 2, IterateOrder::UNDEF, ScheduleType::INNER_PRODUCT, true, true};
    constexpr static MatmulConfig mmStaticConfigPreLoadN =
        GetMMConfig<configMode>(shapeParams, quantParams, batchParams, preloadNfuncParams);
    ...
    MatmulImpl<
        A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, staticTilingPreLoadN, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm2;

    // Define PreloadM statictiling mm obj
    constexpr static MatmulFuncParams preloadMfuncParams{
        false, false, false, false, 1, IterateOrder::UNDEF, ScheduleType::INNER_PRODUCT, true, true};
    constexpr static MatmulConfig mmStaticConfigPreLoadM =
        GetMMConfig<configMode>(shapeParams, quantParams, batchParams, preloadMfuncParams);
    ...
    MatmulImpl<
        A_TYPE, B_TYPE, C_TYPE, BIAS_TYPE, staticTilingPreLoadM, MatmulCallBackFunc<nullptr, nullptr, nullptr>,
        CustomMatmulPolicy>
        mm3;
};

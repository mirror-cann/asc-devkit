...
class TestSchedulerMDLFullLoad : public testing::Test {
protected:
    void SetUp() {}
    void TearDown() {}
...
private:
    ...
    constexpr static MatmulShapeParams shapeParams = {64, 64, 64, 32, 32, 32};
    constexpr static MatmulConfig mmStaticConfig = GetMMConfig<configMode>(shapeParams);
...
TEST_F(TestSchedulerMDLFullLoad, ScheduleOnce)
{

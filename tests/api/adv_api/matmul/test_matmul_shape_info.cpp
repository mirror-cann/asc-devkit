...
class MatmulImpl : MATMUL_IMPORT_MODULE_PRIVATE(MatmulShapeInfo),
...
class TestMatmulShapeInfo : public testing::Test {
protected:
    void SetUp() {}
    void TearDown() {}
...
TEST_F(TestMatmulShapeInfo, test_get_singleCore_params)
{

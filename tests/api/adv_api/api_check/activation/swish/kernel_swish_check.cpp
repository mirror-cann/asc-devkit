...
#include "impl/adv_api/detail/api_check/kernel_check/activation/swish/swish_check.h"
#endif // ASCENDC_CPU_DEBUG
#include "impl/adv_api/detail/api_check/kernel_api_check.h"

class SwishAPICheck : public testing::Test {
protected:
...
TEST_F(SwishAPICheck, SwishAPICheckTestSuccess)
{
    ...
    AscendC::CHECK_FUNC_HIGHLEVEL_API(Swish, (float, false), (dstLocal, srcLocal, dataSize, 3.1));
    EXPECT_EQ(AscendC::KernelRaise::GetInstance().GetRaiseCount() - startCounts, 0);
}

TEST_F(SwishAPICheck, SwishAPICheckTestFailure)
{
    AscendC::TPipe m_pipe;
    ...
    uint8_t dataSize = 32;
    uint64_t startCounts = AscendC::KernelRaise::GetInstance().GetRaiseCount();
    AscendC::CHECK_FUNC_HIGHLEVEL_API(Swish, (uint8_t, true), (dstTensor[1], dstTensor[1], dataSize, 3.1));

...
#include "impl/adv_api/detail/api_check/kernel_check/activation/gelu/gelu_check.h"
#endif // ASCENDC_CPU_DEBUG
#include "impl/adv_api/detail/api_check/kernel_api_check.h"

class GeluAPICheck : public testing::Test {
protected:
...
TEST_F(GeluAPICheck, GeluAPICheckTestSuccess)
{
    ...
    AscendC::CHECK_FUNC_HIGHLEVEL_API(Gelu, (float, true, true), (dstLocal, srcLocal, sharedTmpBuffer, dataSize));
    EXPECT_EQ(AscendC::KernelRaise::GetInstance().GetRaiseCount() - startCounts, 0);
}

TEST_F(GeluAPICheck, GeluAPICheckTestSubFailure)
{
    AscendC::TPipe m_pipe;
    ...
    AscendC::CHECK_FUNC_HIGHLEVEL_API(
        Gelu, (uint8_t, true, true), (dstTensor[1], dstTensor[1], sharedTmpBuffer, dataSize));
    EXPECT_EQ(AscendC::KernelRaise::GetInstance().GetRaiseCount() - startCounts, 3);
}

TEST_F(GeluAPICheck, GeluAPICheckTestFailure)
{
    AscendC::TPipe m_pipe;

...
#include "impl/adv_api/detail/api_check/kernel_check/normalization/groupnorm/groupnorm_check.h"
...
TEST_F(GroupNormAPICheck, GroupNormAPICheckTestSuccess)
{
    ...
    AscendC::CHECK_FUNC_HIGHLEVEL_API(
        GroupNorm, (float, true),
        (output, outputMean, outputVariance, inputX, gamma, beta, sharedTmpBuffer, 1.1, tiling));

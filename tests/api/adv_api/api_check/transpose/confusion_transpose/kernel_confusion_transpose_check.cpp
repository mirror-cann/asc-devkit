...
#include "impl/adv_api/detail/api_check/kernel_check/transpose/confusion_transpose/confusion_transpose_check.h"
#endif // ASCENDC_CPU_DEBUG
#include "impl/adv_api/detail/api_check/kernel_api_check.h"

class ConfusionTransposeAPICheck : public testing::Test {
protected:
...
TEST_F(ConfusionTransposeAPICheck, ConfusionTransposeAPICheckTestSuccess)
{
    ...
    AscendC::CHECK_FUNC_HIGHLEVEL_API(
        ConfusionTranspose, (float),
        (dstTensor, srcTensor, sharedTmpBuffer, AscendC::TransposeType::TRANSPOSE_NZ2ND_0213, tiling));
    EXPECT_EQ(AscendC::KernelRaise::GetInstance().GetRaiseCount() - startCounts, 0);
}

TEST_F(ConfusionTransposeAPICheck, ConfusionTransposeAPICheckTestFailure)
{
    AscendC::TPipe m_pipe;
    ...
    uint64_t startCounts = AscendC::KernelRaise::GetInstance().GetRaiseCount();
    AscendC::CHECK_FUNC_HIGHLEVEL_API(
        ConfusionTranspose, (uint8_t),
        (dstTensor[1], dstTensor[1], sharedTmpBuffer, AscendC::TransposeType::TRANSPOSE_TYPE_NONE, tiling));

...
#include "impl/adv_api/detail/api_check/kernel_check/math/axpy/axpy_check.h"
#endif // ASCENDC_CPU_DEBUG
#include "impl/adv_api/detail/api_check/kernel_api_check.h"

class AxpyAPICheck : public testing::Test {
protected:
...
TEST_F(AxpyAPICheck, AxpyAPICheckTestSuccess)
{
    ...
    m_pipe.InitBuffer(m_queSrc, 1, 32 * sizeof(half));
...
TEST_F(AxpyAPICheck, AxpyAPICheckTestSubFailure)
{
    AscendC::TPipe m_pipe;
...
TEST_F(AxpyAPICheck, AxpyAPICheckTestFailure)
{
    AscendC::TPipe m_pipe;

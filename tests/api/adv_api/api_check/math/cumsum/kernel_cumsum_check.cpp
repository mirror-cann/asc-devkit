...
#include "impl/adv_api/detail/api_check/kernel_check/math/cumsum/cumsum_check.h"
#endif // ASCENDC_CPU_DEBUG
#include "impl/adv_api/detail/api_check/kernel_api_check.h"

class CumSumAPICheck : public testing::Test {
protected:
...
TEST_F(CumSumAPICheck, CumSumAPICheckTestSuccess)
{
    ...
    AscendC::TQue<AscendC::TPosition::VECIN, 1> m_queRow;
    m_pipe.InitBuffer(m_queRow, 1, 32 * sizeof(float));
    AscendC::LocalTensor<float> lastRowTensor = m_queRow.AllocTensor<float>();
    lastRowTensor.SetSize(32);
    ...
    static constexpr AscendC::CumSumConfig config{true, false, true};
...
TEST_F(CumSumAPICheck, CumSumAPICheckTestSubFailure)
{
    AscendC::TPipe m_pipe;
...
TEST_F(CumSumAPICheck, CumSumAPICheckTestFailure)
{
    AscendC::TPipe m_pipe;

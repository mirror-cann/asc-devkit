...
INSTANTIATE_TEST_CASE_P(
    TEST_OPERATTION_MAX, MaxTestsuite,
    ::testing::Values(
        MaxTestParams{4, 8, 32, true, MainMax<float, true>}, MaxTestParams{4, 7, 35, true, MainMax<float, true>},
        MaxTestParams{4, 16, 128, true, MainMax<float, false>}, MaxTestParams{4, 1, 8, false, MainMax<float, true>},
        MaxTestParams{4, 8, 1, false, MainMax<float, false>}, MaxTestParams{4, 16, 7, false, MainMax<float, true>},
        MaxTestParams{4, 4, 8, true, MainMax<float, false>}, MaxTestParams{4, 7, 1, true, MainMax<float, false>},
        MaxTestParams{4, 4, 64, true, MainMax<float, true>}, MaxTestParams{2, 16, 128, true, MainMax<float, false>},
        MaxTestParams{2, 8, 16, true, MainMax<float, false>}, MaxTestParams{2, 7, 55, true, MainMax<float, true>},
        MaxTestParams{2, 7, 1, true, MainMax<float, false>}, MaxTestParams{2, 1, 8, false, MainMax<float, true>},
        MaxTestParams{2, 8, 1, false, MainMax<float, false>}, MaxTestParams{2, 16, 15, false, MainMax<float, true>}));

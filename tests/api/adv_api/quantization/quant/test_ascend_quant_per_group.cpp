...
INSTANTIATE_TEST_CASE_P(
    TEST_OPEARATION_ASCEND_QUANT_PER_GROUP, AscendQuantPerGroupTestsuite,
    ::testing::Values(
        AscendQuantPerGroupTestParams{10, 256, 1280, 32, Entry<half, fp4x2_e1m2_t, half, true, 1, true>},

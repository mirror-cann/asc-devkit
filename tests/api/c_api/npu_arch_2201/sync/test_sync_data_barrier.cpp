...
namespace {
void asc_sync_data_barrier_stub(mem_dsb_t arg) { EXPECT_EQ(mem_dsb_t::DSB_ALL, arg); }
} // namespace

TEST_F(TestSyncDataBarrierCAPI, c_api_sync_data_barrier_Succ)
{
    mem_dsb_t arg = mem_dsb_t::DSB_ALL;
    MOCKER_CPP(dsb, void(mem_dsb_t)).times(1).will(invoke(asc_sync_data_barrier_stub));

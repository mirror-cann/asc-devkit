...
#ifndef TESTS_UNIT_BASIC_API_UT_TESTCASE_C_API_NPU_ARCH_2201_UTILS_TEST_BINARY_INSTR_DIFF_TYPES_H
#define TESTS_UNIT_BASIC_API_UT_TESTCASE_C_API_NPU_ARCH_2201_UTILS_TEST_BINARY_INSTR_DIFF_TYPES_H
...
#define TEST_VECTOR_COMPUTE_BINARY_INSTR_DIFF_TYPES(class_name, c_api_name, cce_name, dst_type, src_type)            \
                                                                                                                     \
    ...
    namespace {                                                                                                      \
                                                                                                                     \
    void cce_name##_##dst_type##_##src_type##_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_Stub(          \
...
{                                                                                                              \
        ...
        EXPECT_EQ(src1_repeat_stride, static_cast<uint8_t>(8));                                                      \
                                                                                                                     ...
                                                                                                                     \
    void cce_name##_##dst_type##_##src_type##_##src_type##_uint64_t_Stub(                                            \
        __ubuf__ dst_type* dst, __ubuf__ src_type* src0, __ubuf__ src_type* src1, uint8_t repeat,                    \
        uint8_t dst_block_stride, uint8_t src0_block_stride, uint8_t src1_block_stride, uint8_t dst_repeat_stride,   \
        uint8_t src0_repeat_stride, uint8_t src1_repeat_stride)                                                      \
    {                                                                                                                \
        ...
        EXPECT_EQ(src1, reinterpret_cast<__ubuf__ src_type*>(33));                                                   \
                                                                                                                     ...
                                                                                                                     \
    void cce_name##_##dst_type##_##src_type##_set_vector_mask_Stub(uint64_t mask1, uint64_t mask0)                   \
    {                                                                                                                \
        ...
        EXPECT_EQ(mask0, static_cast<uint64_t>(44));                                                                 \
                                                                                                                     ...
                                                                                                                     \
    TEST_F(TestVectorCompute##class_name##dst_type##_##src_type, c_api_name##_half_half_half_BinaryConfig_Succ)      \
    {                                                                                                                \
        __ubuf__ dst_type* dst = reinterpret_cast<__ubuf__ dst_type*>(11);                                           \
        __ubuf__ src_type* src0 = reinterpret_cast<__ubuf__ src_type*>(22);                                          \
        __ubuf__ src_type* src1 = reinterpret_cast<__ubuf__ src_type*>(33);                                          \
                                                                                                                     \
        ...
        MOCKER_CPP(                                                                                                  \
            cce_name, void(                                                                                          \
                          __ubuf__ dst_type*, __ubuf__ src_type*, __ubuf__ src_type*, uint8_t, uint8_t, uint8_t,     \
                          uint8_t, uint8_t, uint8_t, uint8_t))                                                       \
            .times(1)                                                                                                \
            .will(invoke(                                                                                            \
                cce_name##_##dst_type##_##src_type##_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_Stub)); \
                                                                                                                     \
        c_api_name(                                                                                                  \
        ...
        GlobalMockObject::verify();                                                                                  \
                                                                                                                     ...
                                                                                                                     \
    TEST_F(TestVectorCompute##class_name##dst_type##_##src_type, c_api_name##_half_half_half_int32_t_Succ)           \
    {                                                                                                                \
        __ubuf__ dst_type* dst = reinterpret_cast<__ubuf__ dst_type*>(11);                                           \
        __ubuf__ src_type* src0 = reinterpret_cast<__ubuf__ src_type*>(22);                                          \
        __ubuf__ src_type* src1 = reinterpret_cast<__ubuf__ src_type*>(33);                                          \
        ...
        MOCKER_CPP(set_vector_mask, void(uint64_t, uint64_t))                                                        \
            .times(1)                                                                                                \
            .will(invoke(cce_name##_##dst_type##_##src_type##_set_vector_mask_Stub));                                \
                                                                                                                     \
        MOCKER_CPP(                                                                                                  \
            cce_name, void(                                                                                          \
                          __ubuf__ dst_type*, __ubuf__ src_type*, __ubuf__ src_type*, uint8_t, uint8_t, uint8_t,     \
                          uint8_t, uint8_t, uint8_t, uint8_t))                                                       \
            .times(1)                                                                                                \
            .will(invoke(cce_name##_##dst_type##_##src_type##_##src_type##_uint64_t_Stub));                          \
                                                                                                                     \

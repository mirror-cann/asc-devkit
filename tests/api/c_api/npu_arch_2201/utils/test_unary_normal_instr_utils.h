...
#ifndef TESTS_UNIT_BASIC_API_UT_TESTCASE_C_API_NPU_ARCH_2201_UTILS_TEST_UNARY_NORMAL_INSTR_UTILS_H
#define TESTS_UNIT_BASIC_API_UT_TESTCASE_C_API_NPU_ARCH_2201_UTILS_TEST_UNARY_NORMAL_INSTR_UTILS_H
...
#define TEST_VECTOR_COMPUTE_UNARY_NORMAL_INSTR(class_name, c_api_name, cce_name, data_type)                          \
                                                                                                                     \
...
{                                                                                                              \
    ...
    {                                                                                                                \
        ...
        uint8_t repeat = 1;                                                                                          \
                                                                                                                     \
        MOCKER_CPP(                                                                                                  \
            cce_name, void(__ubuf__ data_type*, __ubuf__ data_type*, uint8_t, uint16_t, uint16_t, uint8_t, uint8_t)) \
            .times(1)                                                                                                \

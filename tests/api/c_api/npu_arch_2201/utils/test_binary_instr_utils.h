...
#ifndef TESTS_UNIT_BASIC_API_UT_TESTCASE_C_API_NPU_ARCH_2201_UTILS_TEST_BINARY_INSTR_UTILS_H
#define TESTS_UNIT_BASIC_API_UT_TESTCASE_C_API_NPU_ARCH_2201_UTILS_TEST_BINARY_INSTR_UTILS_H
...
#define TEST_VECTOR_COMPUTE_RELU_CONV_INSTR(class_name, c_api_name, cce_name, dst_data_type, src_data_type)                         \
    ...
    namespace {                                                                                                                     \
                                                                                                                                    \
    void                                                                                                                            \
        cce_name##_##dst_data_type##_##src_data_type##_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_bool_Stub(           \
            __ubuf__ dst_data_type* dst, __ubuf__ src_data_type* src0, __ubuf__ src_data_type* src1, uint8_t repeat,                \
            uint8_t dst_block_stride, uint8_t src0_block_stride, uint8_t src1_block_stride, uint8_t dst_repeat_stride,              \
            uint8_t src0_repeat_stride, uint8_t src1_repeat_stride, bool h)                                                         \
    {                                                                                                                               \
        ...
        EXPECT_EQ(h, false);                                                                                                        \
                                                                                                                                    ...
                                                                                                                                    \
    void cce_name##_##dst_data_type##_##src_data_type##_uint64_t_bool_Stub(                                                         \
        __ubuf__ dst_data_type* dst, __ubuf__ src_data_type* src0, __ubuf__ src_data_type* src1, uint8_t repeat,                    \
        uint8_t dst_block_stride, uint8_t src0_block_stride, uint8_t src1_block_stride, uint8_t dst_repeat_stride,                  \
        uint8_t src0_repeat_stride, uint8_t src1_repeat_stride, bool h)                                                             \
    {                                                                                                                               \
        ...
        EXPECT_EQ(src1, reinterpret_cast<__ubuf__ src_data_type*>(33));                                                             \
                                                                                                                                    ...
                                                                                                                                    \
    void cce_name##dst_data_type##_##src_data_type##_set_vector_mask_Stub(uint64_t mask1, uint64_t mask0)                           \
    {                                                                                                                               \
        EXPECT_EQ(mask1, static_cast<uint64_t>(0));                                                                                 \
        EXPECT_EQ(mask0, static_cast<uint64_t>(44));                                                                                \
    }                                                                                                                               \
    ...
    {                                                                                                                               \
        ...
        MOCKER_CPP(                                                                                                                 \
            cce_name, void(                                                                                                         \
                          __ubuf__ dst_data_type*, __ubuf__ src_data_type*, __ubuf__ src_data_type*, uint8_t, uint8_t,              \
    ...
    {                                                                                                                               \
        ...
        MOCKER_CPP(set_vector_mask, void(uint64_t, uint64_t))                                                                       \
            .times(1)                                                                                                               \
            .will(invoke(cce_name##dst_data_type##_##src_data_type##_set_vector_mask_Stub));                                        \
                                                                                                                                    \
        MOCKER_CPP(                                                                                                                 \
            cce_name, void(                                                                                                         \
                          __ubuf__ dst_data_type*, __ubuf__ src_data_type*, __ubuf__ src_data_type*, uint8_t, uint8_t,              \

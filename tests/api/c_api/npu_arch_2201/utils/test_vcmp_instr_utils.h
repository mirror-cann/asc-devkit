...
#define TEST_VECTOR_COMPUTE_COMPARE_VCMP_INSTR(class_name, c_api_name, cce_name, src_type)                           \
    ...
    namespace {                                                                                                      \
                                                                                                                     \
    void cce_name##_##src_type##uint8_t_Stub(                                                                        \
        __ubuf__ src_type* src0, __ubuf__ src_type* src1, uint8_t repeat, uint8_t dst_block_stride,                  \
    ...
    {                                                                                                                \
        ...
        MOCKER_CPP(                                                                                                  \
            cce_name, void(                                                                                          \
                          __ubuf__ src_type*, __ubuf__ src_type*, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t,       \
                          uint8_t, uint8_t))                                                                         \
            .times(1)                                                                                                \

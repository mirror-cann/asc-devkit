...
#define TEST_VECTOR_COMPUTE_CONV_DEQ_INSTR(class_name, c_api_name, cce_name, dst_data_type, src_data_type)          \
    ...
    void cce_name##_##dst_data_type##_##src_data_type##_UnaryCfg_Stub(                                              \
        __ubuf__ dst_data_type* dst, __ubuf__ void* src, uint8_t repeat, uint16_t dst_block_stride,                 \
    ...
    {                                                                                                               \
        ...
        uint8_t repeat = static_cast<uint64_t>(1);                                                                  \
                                                                                                                    \
        MOCKER_CPP(                                                                                                 \
            cce_name, void(__ubuf__ dst_data_type*, __ubuf__ void*, uint8_t, uint16_t, uint16_t, uint8_t, uint8_t)) \
            .times(1)                                                                                               \
...
// ==========asc_int42half==========
TEST_VECTOR_COMPUTE_CONV_DEQ_INSTR(ConvI42HCApi, asc_int42half, vconv_s42f16, half, int4b_t);
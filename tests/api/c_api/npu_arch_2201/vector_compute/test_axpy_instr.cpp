...
#define TEST_VECTOR_COMPUTE_CONV_VALUE_INSTR(class_name, c_api_name, cce_name, dst_data_type, src_data_type)           \
                                                                                                                       \
    ...
    void cce_name##_##dst_data_type##_##src_data_type##_UnaryCfg_Stub(                                                 \
        __ubuf__ dst_data_type* dst, __ubuf__ src_data_type* src, src_data_type value, uint8_t repeat,                 \
    ...
    {                                                                                                                  \
        ...
        EXPECT_EQ(value, static_cast<src_data_type>(33));                                                              \
    ...
    {                                                                                                                  \
        ...
        src_data_type value = static_cast<src_data_type>(33);                                                          \
                                                                                                                       \
        ...
        MOCKER_CPP(                                                                                                    \
            cce_name, void(                                                                                            \
                          __ubuf__ dst_data_type*, __ubuf__ src_data_type*, src_data_type, uint8_t, uint16_t,          \
...
TEST_VECTOR_COMPUTE_CONV_VALUE_INSTR(CAPIVAXPY, asc_axpy, vaxpy, half, half);
TEST_VECTOR_COMPUTE_CONV_VALUE_INSTR(CAPIVAXPY, asc_axpy, vaxpy, float, float);
TEST_VECTOR_COMPUTE_CONV_VALUE_INSTR(CAPIVAXPY, asc_axpy, vaxpy, float, half);
...
template <typename T, int mode>
__global__ __aicore__ void testReduceMin(
...
class reduceMinTestsuite : public testing::Test, public testing::WithParamInterface<reduceMinParams> {
protected:
...
INSTANTIATE_TEST_CASE_P(
    TEST_OPEARATION_REDUCE_MIN, reduceMinTestsuite,
    ::testing::Values(
        reduceMinParams{2, 2, 128, testReduceMin<half, 0>}, reduceMinParams{4, 4, 64, testReduceMin<int32_t, 0>},
        reduceMinParams{4, 4, 64, testReduceMin<uint32_t, 0>}, reduceMinParams{4, 4, 64, testReduceMin<int16_t, 0>},
        reduceMinParams{4, 4, 64, testReduceMin<uint16_t, 0>}, reduceMinParams{4, 4, 64, testReduceMin<float, 0>}));

...
#else
#include "reg_compute/kernel_reg_compute_vec_ternary_scalar_intf.h"
#endif

extern "C" __simd_vf__ void vec_ternary_scalar_test()
{
    ...
    AscendC::Reg::Axpy<float, float, AscendC::Reg::MaskMergeMode::ZEROING>(dstReg, srcReg, 2.0f, mask);
}

...
HcclResult AllReduceOpbasePipeline::RunReduceScatterInterServer(
    u32 step, const LINK& prevInterLink, const LINK& nextInterLink)
{
...
HcclResult AllReduceOpbasePipeline::RunAllGatherInterServer(
    u32 step, const LINK& prevInterLink, const LINK& nextInterLink)
{
    CHK_RET(prevInterLink->TxAck(stream_));
    CHK_RET(nextInterLink->RxAck(stream_));

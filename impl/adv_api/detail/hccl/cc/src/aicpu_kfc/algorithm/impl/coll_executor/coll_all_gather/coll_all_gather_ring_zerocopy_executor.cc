...
HcclResult CollAllGatherRingZerocopyExecutor::CalcTransportMemType(
...
HcclResult CollAllGatherRingZerocopyExecutor::KernelRunInterServerPreProcess(
...
HcclResult CollAllGatherRingZerocopyExecutor::KernelRunInterServerPostProcess(
    const OpParam& param, const ExecMem& execMem)
{
    u32 unitSize = 0;

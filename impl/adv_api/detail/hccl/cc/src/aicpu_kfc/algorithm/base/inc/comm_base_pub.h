...
public:
    explicit CommBase(
        ...
        const bool isUsedRdmaLevel0, const void* transportResourceInfoAddr = nullptr,
        size_t transportResourceInfoSize = 0, const std::string& tag = "",
    ...
    inline const u32 UserRank() const { return userRank_; }

    inline const u32 UserRankSize() const { return userRankSize_; }

    inline const u32 Rank() const { return rank_; }

    inline const u32 RankSize() const { return rankSize_; }

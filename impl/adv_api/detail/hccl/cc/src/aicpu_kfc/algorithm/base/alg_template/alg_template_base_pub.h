...
public:
    ...
    // AllGatherRingDirect
    virtual HcclResult Prepare(
        HcomCollOpInfo* opInfo, u32 userRank, const std::vector<Slice>& userMemOutputSlices, bool isSdma = true);
    ...
    static HcclResult ExecEmptyTask(
    ...
    static HcclResult PrepareSliceData(
...
protected:
    ...
    HcclResult ExecuteTxSync(
        ...
        Stream& stream) const;
    virtual HcclResult PrepareRunAsync(
        const u32 rank, const u32 rankSize, const std::vector<std::shared_ptr<Transport>>& links);
...
private:
    ...
    static HcclResult CalcBinaryBlockHalvingDoubleLinkReleation(
    ...
    static void CalcRecursiveHalvingDobuleLinkReleation(
        u32 rank, u32 rankSize, u32 rootRank, std::vector<bool>& linkRelation);
    static void CalcRecursiveHdLinkRelationForFirstScene(
        u32 rank, u32 part1Size, u32 blockSize, std::vector<bool>& linkRelation);
    static void CalcRecursiveHdLinkRelationForSecondScene(
        u32 rank, u32 part1Size, u32 blockSize, std::vector<bool>& linkRelation);
};

...
public:
    explicit hcclImpl(
        ...
        CCLBufferManager& cclBufferManager, const void* transportResourceInfoAddr, size_t transportResourceInfoSize,
        HcclAlgoAttr& algoAttr, HcclTopoAttr& topoAttr, std::shared_ptr<AlgConfigurator> algConfigurator,

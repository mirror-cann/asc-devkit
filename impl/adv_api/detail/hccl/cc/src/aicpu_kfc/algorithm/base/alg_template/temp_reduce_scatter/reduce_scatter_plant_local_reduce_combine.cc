...
HcclResult ReduceScatterPlantLocalReduceCombine::MainRecordSub(
    Stream& mainStream, u32 firstSubStreamIndex, u32 totalTask)
{
...
HcclResult ReduceScatterPlantLocalReduceCombine::RunAsync(
...
HcclResult ReduceScatterPlantLocalReduceCombine::RunAlltoAllRDMA(
    u32 round, u64 sliceSize, const std::vector<LINK>& links)
{
...
HcclResult ReduceScatterPlantLocalReduceCombine::RunAlltoAllSDMA(
    u32 round, u64 sliceSize, const std::vector<LINK>& links)
{
    if (sliceSize != 0) {
        DeviceMem src;

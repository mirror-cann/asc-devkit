    ...
    const u64 baseOffset)
{
    ...
    std::unique_ptr<AlgTemplateBase> tempAlg =
        AlgTemplateRegistry::Instance().GetAlgTemplate(TemplateType::TEMPLATE_SCATTER_DOUBLE_RING_DIRECT, dispatcher_);
    ...
    const OpParam& param, ExecMem& execMem, const u64 level1DataSize)
{
    ...
    if (algType_.algoLevel1 == AlgTypeLevel1::ALG_LEVEL1_NHR) {
        ...
        level1TempAlg =
            AlgTemplateRegistry::Instance().GetAlgTemplate(TemplateType::TEMPLATE_BROADCAST_RECURSIVE_HD, dispatcher_);

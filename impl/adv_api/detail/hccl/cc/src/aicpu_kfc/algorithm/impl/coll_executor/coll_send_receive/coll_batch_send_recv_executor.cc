...
HcclResult CollBatchSendRecvExecutor::SendKernelRun(
    Stream& stream, ExecMem& execMem, u32 remoteUserRank, bool retryEnable)
{
    LINK targetLink;
...
HcclResult CollBatchSendRecvExecutor::RecvKernelRun(
    Stream& stream, ExecMem& execMem, u32 remoteUserRank, bool retryEnable)
{
    LINK targetLink;

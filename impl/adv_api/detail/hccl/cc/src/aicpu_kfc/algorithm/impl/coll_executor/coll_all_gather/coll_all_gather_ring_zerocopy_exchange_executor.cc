...
HcclResult CollAllGatherRingZerocopyExchangeExecutor::CalcExchangeCommInfo(
...
HcclResult CollAllGatherRingZerocopyExchangeExecutor::KernelRunInterServerPreProcess(
...
HcclResult CollAllGatherRingZerocopyExchangeExecutor::KernelRunInterServerPostProcess(
    const OpParam& param, const ExecMem& execMem)
{

...
public:
    ...
    virtual HcclResult SetExcutorExtraInfo(
    ...
    static HcclResult RunAlltoAllTemplate(
        const std::unique_ptr<AlgTemplateBase>& executor, const SubCommInfo& commInfo);
    static HcclResult RunAlltoAllVTemplateStaged(
        const std::unique_ptr<AlgTemplateBase>& executor, const SubCommInfo& commInfo);
    static HcclResult RunTemplateWithVirtualLink(
        const std::unique_ptr<AlgTemplateBase>& executor, const SubCommInfo& commInfo);

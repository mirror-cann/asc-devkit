...
HcclResult CollAllGatherRingFor91093Executor::CalcTransportMemType(
    ...
    const SubCommInfo& level0CommInfo, u32 perDataSize, u64 inputMemSize) const
{
    ...
    for (u32 i = 0; i < level2RankSize; i++) {
        ...
        sliceTemp.offset = inputMemSize * (i * level1RankSize * level0RankSize + level1ServerIndex * level0RankSize +
                                           level0ServerIndex);
...
HcclResult CollAllGatherRingFor91093Executor::SelectTempAlg(

    ...
    const std::vector<std::vector<Slice>> multRingsUserMemSlice)
{
    ...
    std::unique_ptr<AlgTemplateBase> executor =
        AlgTemplateRegistry::Instance().GetAlgTemplate(TemplateType::TEMPLATE_REDUCESCATTER_UNIFIED_MARCH, dispatcher_);
...
HcclResult CollReduceScatterRingZerocopyExecutor::KernelRunInterServerPreProcess(
...
HcclResult CollReduceScatterRingZerocopyExecutor::KernelRunInterServerPostProcess(
    const OpParam& param, const ExecMem& execMem)
{

...
HcclResult CollReduceScatterRingExecutor::CalcTransportMemType(
...
HcclResult CollReduceScatterRingExecutor::KernelRun(const OpParam& param, ExecMem& execMem)
{
    ...
    bool isInlineReduce =
        IsSupportSDMAReduce(execMem.inputMem.ptr(), execMem.scratchMem.ptr(), param.DataDes.dataType, param.reduceType);
...
HcclResult CollReduceScatterRingExecutor::SelectTempAlg(

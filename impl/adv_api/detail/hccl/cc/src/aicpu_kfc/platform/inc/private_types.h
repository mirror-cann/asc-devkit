...
struct TransportResourceInfo {
    ...
    TransportResourceInfo(
        ...
        : mrManager(mrManager),
          ...
          hdcHostWqeBatchNum(DEFAULT_BATCH_NUM)
    {}
    TransportResourceInfo(const TransportResInfo& res)
        : mrManager(res.mrManager),
          pMsgInfosMem(res.pMsgInfosMem),
          pReqInfosMem(res.pReqInfosMem),
          memBlocksManager(res.memBlocksManager),
          pRecvWrInfosMem(res.pRecvWrInfosMem),
          tagSrqInfo(SrqInfo()),
          dataSrqInfo(SrqInfo()),
          flag(QP_FLAG_RC),
          lkey(res.lkey),

...
HcclResult DlRaFunction::DlRaFunctionRdmaInit()
{
    ...
    dlRaRecvWrlist =
        (int (*)(QpHandle handle, struct RecvWrlistData* wr, unsigned int recvNum, unsigned int* completeNum))HcclDlsym(
            handle_, "RaRecvWrlist");
...
HcclResult DlRaFunction::DlRaFunctionSocketInit()
{
    ...
    dlRaGetDevEidInfoList =
        (int (*)(RaInfo info, struct HccpDevEidInfo* eid_info, unsigned int*))HcclDlsym(handle_, "RaGetDevEidInfoList");

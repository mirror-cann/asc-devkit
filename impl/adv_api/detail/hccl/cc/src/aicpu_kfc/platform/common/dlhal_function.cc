...
HcclResult DlHalFunction::DlHalFunctionEschedInit()
{
    ...
    dlHalEschedRegisterAckFunc = (drvError_t(*)(
        unsigned int, unsigned int,
        void (*ackFunc)(unsigned int, unsigned int, u8*, unsigned int)))HcclDlsym(handle_, "halEschedRegisterAckFunc");
    ...
    dlHalGrpQuery =
        (drvError_t(*)(GroupQueryCmdType, void*, unsigned int, void*, unsigned int*))HcclDlsym(handle_, "halGrpQuery");

...
public:
    ...
    // 重构后的版本
    HcclResult InitV2(
        NICDeployment nicDeploy, bool isBackup, u32 devicePhyId = DEFAULT_PHY_ID, bool isHostUseDevNic = false);
...
private:
    ...
    HcclResult CheckSocketInfo(
        const SocketHandle socketHandle, const HcclIpAddress& ipAddr, u32 port = NO_LISTEN_PORT) const;
    ...
    HcclResult GetConfigAndRaDeinit(

...
public:
    ...
    ~LocalIpcNotify();
    HcclResult Init(
        const s32 localDeviceId, const s32 remoteDeviceId, const NotifyLoadType type = NotifyLoadType::HOST_NOTIFY);
    ...
    HcclResult Post(
        Stream& stream, HcclDispatcher dispatcher, s32 stage = INVALID_VALUE_STAGE, u32 remoteUserRank = INVALID_UINT);

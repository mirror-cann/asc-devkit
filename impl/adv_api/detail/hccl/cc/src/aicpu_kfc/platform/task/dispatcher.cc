...
HcclResult DispatcherPub::MemcpySync(
    void* dst, uint64_t destMax, const void* src, uint64_t count, HcclRtMemcpyKind kind)
{
...
HcclResult DispatcherPub::RdmaSend(
    u32 qpn, u32 wqeIndex, const struct SendWr& wr, hccl::Stream& stream, u32 userRank, u64 offset)
{
    u64 NotifyID =

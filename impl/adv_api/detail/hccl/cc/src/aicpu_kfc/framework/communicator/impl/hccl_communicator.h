...
public:
    ...
    virtual HcclResult BatchSendRecv(
    ...
    HcclResult SetWorkspaceResource(
...
private:
    ...
    HcclResult SetDynamicTilingDataAlltoallv(
...
private:
    ...
    HcclResult NslbDp_CollectSendAdjTable(
    ...
    HcclResult CalcTinySendRecvMem(
    ...
    HcclResult CopyHostAirmaInfoToDeviceParam(

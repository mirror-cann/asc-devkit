...
ReadWriteLockBase& AicpuHcclProcess::AicpuGetCommMutex() { return g_commAicpuInfo.commAicpuMapMutex; }
    ...
    hccl::HcclCommAicpu* hcclCommAicpu, OpTilingData* tilingData, HcclOpResParam* commParam)
{
    ...
    if (opParam.opType == HcclCMDType::HCCL_CMD_BATCH_SEND_RECV) {
        ...
        opParam.All2AllDataDes.sdispls =
            static_cast<void*>(static_cast<u64*>(alltoallvDataPtr->sendRecvInfos) + ALLTOALLV_INFO_INDEX_2 * rankSize);
        opParam.All2AllDataDes.rdispls =
            static_cast<void*>(static_cast<u64*>(alltoallvDataPtr->sendRecvInfos) + ALLTOALLV_INFO_INDEX_3 * rankSize);

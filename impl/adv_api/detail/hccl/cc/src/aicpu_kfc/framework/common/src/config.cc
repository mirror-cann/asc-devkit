...
HcclResult CheckDeviceNumValid(
    const std::vector<RankInfo_t>& rankList, u32 deviceNum, u32 serverNum, std::string version)
{
    if (serverNum == 0) {
...
HcclResult CheckRoleAndRankConsistent(
    const hccl::RoleTableInfo& roleTableInfo, const hccl::HcclCommParams& params, const hccl::RankTable_t& rankTable)
{

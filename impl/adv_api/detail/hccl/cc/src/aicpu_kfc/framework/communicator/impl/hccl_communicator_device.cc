...
HcclResult HcclCommunicator::ClearResMap(const std::string& tag, bool& findTag) { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::ClearOpResource(const std::string& tag) { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::MrManagerInit() { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::MrManagerDeInit() { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::FreeScratchMemOnOpBaseMode(
    DeviceMem& scratchMem, const OpParam& opParam, const HcclCMDType& opType)
{
    return HCCL_SUCCESS;
}
...
HcclResult HcclCommunicator::BuildAiRmaInfoParam(
    const std::string& newTag, const std::string& algName, const HcclCMDType opType)
{
    return HCCL_SUCCESS;
}
...
HcclResult HcclCommunicator::InitRecvMsgAndRequestBuffer() { return HCCL_SUCCESS; }

HcclResult HcclCommunicator::InitMemBlocksAndRecvWrMem() { return HCCL_SUCCESS; }
...
HcclResult HcclCommunicator::GetAiCpuNotifyData(
    const std::shared_ptr<LocalNotify>& localNotify, HcclSignalInfo& notifyInfo)
{
    return HCCL_SUCCESS;
}

HcclResult HcclCommunicator::CreateAndGetAiCpuNotify(
    std::shared_ptr<LocalNotify>& localNotify, HcclSignalInfo& notifyInfo)
{
    return HCCL_SUCCESS;
}
...
HcclResult HcclCommunicator::SetRemoteRankLinkInfo(
    std::unordered_map<u32, bool>& switchRanks, ChangeLinkInfo& changeLinkInfo)
{
    return HCCL_SUCCESS;
}
...
HcclResult HcclCommunicator::DeInitTransportMem() { return HCCL_SUCCESS; }
...
bool HcclCommunicator::EnableAicpuUnfold() { return false; }

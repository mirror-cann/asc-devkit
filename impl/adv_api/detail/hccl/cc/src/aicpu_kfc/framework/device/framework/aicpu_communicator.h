...
public:
    ...
    // 独立算子专用
    HcclResult SetChannelP2pNotify(
...
private:
    ...
    HcclResult PrepareZeroCopyExchanger(
    ...
    HcclResult UpdateSuspendStatus(
    ...
    HcclResult HcclOpExecFsmStoppingProcess(
        const OpParam& param, HcclOpExecFSM& fsmState, KfcError& errorCode, uint32_t retryCnt);

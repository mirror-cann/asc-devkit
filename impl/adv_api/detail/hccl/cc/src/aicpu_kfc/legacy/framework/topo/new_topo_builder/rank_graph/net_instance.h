...
public:
    ...
    public:
        ...
        const std::unordered_map<u32, std::vector<std::shared_ptr<NetInstance::ConnInterface>>> GetInterfacesMap()
            const;
    ...
    public:
        ...
        Peer(
            ...
            u32 devicePort = DEFAULT_LISTENING_PORT)
            : Node(NodeType::PEER),
              rankId_(rankId),
              localId_(localId),
    ...
    public:
        explicit Fabric(FabricId fabricId, PlaneId planeId)
            : Node(NodeType::FABRIC), fabricId_(fabricId), planeId_(planeId)
        {

...
public:
    ...
    void FillCommSqe(
        UdmaSqeCommon* sqe, const RmtRmaBufSliceLite& rmt, const SqeConfigLite& cfg, u32 opCode, u32 cqeEnable = 1);
    ...
    void BatchProcessOneSlice(
        const RmaBufSliceLite& loc, const RmtRmaBufSliceLite& rmt, const SqeConfigLite& cfg, bool isLastSlice,
...
private:
    ...
    void FillOneSqeWrite(
        ...
        UdmaSqOpcode opCode, u32 cqeEnable = 1);

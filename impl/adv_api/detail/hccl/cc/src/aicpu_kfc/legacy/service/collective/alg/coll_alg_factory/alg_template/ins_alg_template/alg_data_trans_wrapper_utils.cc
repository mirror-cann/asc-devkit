...
HcclResult IndividualTransSlicesLists(
    const LinkData& link, InsQuePtr queue, const TransSlicesInfo& slices, DmaMode dmaMode)
{
    CHK_PRT_RET(
...
HcclResult IndividualWriteSlicesListsWithFin(
    const LinkData& link, InsQuePtr queue, const TransSlicesInfo& slices, u32 topicId)
{
    CHK_PRT_RET(

...
void ConstructStore(
    const Rt91095StarsCondIsaRegister_t addrReg, const Rt91095StarsCondIsaRegister_t valReg, const uint16_t immdOffset,
    const Rt91095StarsCondIsaStoreFunc3_t func3, Rt91095StarsCondOpStore_t& opStore)
{
...
void BuildA5SqeRdmaDbSend(u32 streamId, u32 taskId, u64 dbAddr, u64 dbValue, uint8_t* const sqeIn)
{
    ...
    HCCL_INFO("[SQE]RdmaDbSend streamId %u, taskId %u, dbAddr %p, dbValue %llu", streamId, taskId, dbAddr, dbValue);
}
} // namespace Hccl

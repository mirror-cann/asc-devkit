...
HcclResult InsAlgTemplateBase::CalcSliceInfo(
...
std::vector<std::tuple<QId, QId, u32>> InsAlgTemplateBase::CreateMasterSlaveQueNotifiesRequest(
    u32 queueNum, u32 pairNum, QId masterId) const
{

...
template <typename AlgTopoMatch, typename InsAlgTemplate>
HcclResult InsReduceSoleExecutor<AlgTopoMatch, InsAlgTemplate>::CalcRes(
...
template <typename AlgTopoMatch, typename InsAlgTemplate>
HcclResult InsReduceSoleExecutor<AlgTopoMatch, InsAlgTemplate>::OrchestrateOpbase(
    InsAlgTemplate& tempAlg, ParamPool& paramPool)
{
    BuffInfo buffInfo;

...
private:
    ...
    CfgField<u32> rdmaTimeOut{
        "HCCL_RDMA_TIMEOUT", u32(HCCL_RDMA_TIMEOUT_DEFAULT), Str2T<u32>,
...
private:
    ...
    CfgField<u64> bufferSize{
        ...
        CHK_RANGE_CLOSED<u64>(HCCL_CCL_COMM_BUFFER_MIN, ULLONG_MAX),
        [](u64& i) { i *= HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE; }};
    CfgField<HcclAccelerator> hcclAccelerator_{
        "HCCL_OP_EXPANSION_MODE", HcclAccelerator::CCU_SCHED, CastHcclAccelerator};
};

...
InsTempAllReduceMesh1DTwoShot::~InsTempAllReduceMesh1DTwoShot() { HCCL_INFO("[InsTempAllReduceMesh1DTwoShot] exit."); }
    ...
    std::vector<InsQuePtr>& tempInsQues)
{
    ...
    CHK_PRT_RET(
        ...
        HCCL_ERROR(
            "[InsTempAllReduceMesh1DTwoShot] Rank [%d], queNum_:[%u], tempInsQues size:[%zu],requiredQue Error.",

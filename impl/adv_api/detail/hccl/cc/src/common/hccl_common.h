 ...
 */
#ifndef MC2_OPS_HCCL_COMMON_H
#define MC2_OPS_HCCL_COMMON_H
...
const std::map<HcclDataType, std::string> HCOM_DATA_TYPE_STR_MAP{
    ...
    {HcclDataType::HCCL_DATA_TYPE_FP8E8M0, "fp8e8m0"},  {HcclDataType::HCCL_DATA_TYPE_MXFP8, "mxfp8"},
...
inline const char* GetHcclDataTypeStr(HcclDataType type) noexcept
{
    switch (type) {
        ...
        case HcclDataType::HCCL_DATA_TYPE_FP8E8M0:
            return "fp8e8m0";
        case HcclDataType::HCCL_DATA_TYPE_MXFP8:
            return "mxfp8";

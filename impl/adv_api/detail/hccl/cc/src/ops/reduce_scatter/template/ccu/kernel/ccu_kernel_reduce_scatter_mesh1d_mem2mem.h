...
public:
    explicit CcuKernelArgReduceScatterMesh1DMem2Mem(
    ...
    {
        HCCL_DEBUG(
            "[CcuKernelArgReduceScatterMesh1DMem2Mem] dimSize: %lu, rankId: %u, reduceOp: %d, dataType: %d", dimSize_,
            rankId_, opParam.reduceType, opParam.DataDes.dataType);
    }
...
public:
    explicit CcuTaskArgReduceScatterMesh1DMem2Mem(
    ...
    {
        HCCL_INFO(
            "[CcuTaskArgReduceScatterMesh1DMem2Mem] inputAddr: %lu, outputAddr: %lu, scratchAddr: %lu, "

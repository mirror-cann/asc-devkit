...
public:
    explicit CcuKernelArgReduceScatterMesh1D(
    ...
    {
        HCCL_DEBUG(
            "[CcuKernelArgReduceMesh1D] dimSize: %lu, rankId: %u, reduceOp: %d, dataType: %d", dimSize_, rankId_,
...
public:
    ...
    {
        HCCL_DEBUG(
            "[CcuTaskArgReduceScatterMesh1D] inputAddr: %lu, outputAddr: %lu, sliceSize: %lu, offset: %lu", inputAddr_,
            outputAddr_, sliceSize_, offset_);
    }

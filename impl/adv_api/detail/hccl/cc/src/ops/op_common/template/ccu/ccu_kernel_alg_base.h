...
protected:
    ...
    HcclResult GroupReduceWithoutMyRank(
    ...
    HcclResult GroupLocalReduce(
        CcuRep::LocalAddr outDstOrg, std::vector<CcuRep::LocalAddr>& scratchOrg, GroupOpSize goSize,
...
private:
    ...
    HcclResult CreateMultiOpReduce(
        const std::vector<ChannelHandle>& channels, HcclDataType dataType, HcclDataType outputDataType,
        HcclReduceOp opType);
    HcclResult CreateMultiOpReduceWithoutMyRank(
        const std::vector<ChannelHandle>& ccuChannels, HcclDataType dataType, HcclDataType outputDataType,
        HcclReduceOp opType);
    HcclResult CreateReduceLoop(uint32_t size, HcclDataType dataType, HcclDataType outputDataType, HcclReduceOp opType);

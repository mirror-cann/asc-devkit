...
public:
    explicit CcuKernelArgAllGatherMesh1DMem2Mem(
    ...
    {
        HCCL_DEBUG("[CcuKernelArgAllGatherMesh1DMem2Mem] dimSize: %lu, rankId: %u", dimSize_, rankId_);
    }
...
public:
    explicit CcuTaskArgAllGatherMesh1DMem2Mem(
    ...
    {
        HCCL_DEBUG(
            "[CcuTaskArgAllGatherMesh1DMem2Mem] inputAddr: %lu, outputAddr: %lu, inputSliceStride: %lu, "

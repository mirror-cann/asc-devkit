    ...
    AlgResourceRequest& resourceRequest)
{
    ...
    kernelInfo.kernelArg = std::make_shared<CcuKernelArgAllGatherNHR1DMultiJettyMem2Mem>(
        subCommRanks_[0].size(), mySubCommRank_, param, jettyNum_, stepInfoVector, rank2ChannelIdx, subCommRanks_);

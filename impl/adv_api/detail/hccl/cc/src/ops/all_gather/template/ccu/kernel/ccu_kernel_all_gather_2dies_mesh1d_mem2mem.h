...
public:
    explicit CcuKernelArgAllGather2DiesMeshMem2Mem1D(
        ...
        : dimSize_(dimSize),
          ...
          opParam_(opParam)
    {
        HCCL_DEBUG("[CcuKernelArgAllGather2DiesMeshMem2Mem1D] dimSize: %lu, rankId: %u", dimSize_, rankId_);
    }
...
public:
    explicit CcuTaskArgAllGather2DiesMeshMem2Mem1D(

...
#ifndef API_CONV3D_MTE1_SUB_API_H
#define API_CONV3D_MTE1_SUB_API_H
...
public:
    ...
    __aicore__ inline void LoadAL0()
    {
        ...
        AscendC::LoadData3DParamsV2<typename Intf::InputT> loadData3Dv2Params = aL1Tools_->GetLoadData3DParams();
        SetLoadData3DParamsV2(loadData3Dv2Params);

        AscendC::LoadData<typename Intf::InputT, CONV3D_LOAD3DV2_DEFAULT_CONFIG>(
...
private:
    __aicore__ inline void SetLoadData2DParams(AscendC::LoadData2DParams& loadData2dParams, const uint64_t& repeatTimes)
    {
        ...
        KERNEL_LOG(KERNEL_DEBUG, "[LoadBL0] loadData2dParams.repeatTimes %d.\n", loadData2dParams.repeatTimes);
    }

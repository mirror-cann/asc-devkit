...
__simd_callee__ inline void asc_or_impl(vector_uint32_t& dst, vector_uint32_t src0, vector_uint32_t src1, vector_bool mask)
{
    if ASC_IS_AIV {
        vor(dst, src0, src1, mask, MODE_ZEROING);
    }
...
__simd_callee__ inline void asc_or_impl(vector_uint16_t& dst, vector_uint16_t src0, vector_uint16_t src1, vector_bool mask)
{
    if ASC_IS_AIV {
        vor(dst, src0, src1, mask, MODE_ZEROING);
    }

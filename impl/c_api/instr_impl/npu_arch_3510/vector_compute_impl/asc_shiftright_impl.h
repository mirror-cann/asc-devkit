...
__simd_callee__ inline void asc_shiftright_impl(vector_uint8_t& dst,
    vector_uint8_t src0, vector_int8_t src1, vector_bool mask)
{
    if ASC_IS_AIV {
        vshr(dst, src0, src1, mask, MODE_ZEROING);
    }
}

__simd_callee__ inline void asc_shiftright_impl(vector_int8_t& dst,
...
__simd_callee__ inline void asc_shiftright_impl(vector_uint16_t& dst,
...
__simd_callee__ inline void asc_shiftright_impl(vector_int16_t& dst,
...
__simd_callee__ inline void asc_shiftright_impl(vector_uint32_t& dst,
...
__simd_callee__ inline void asc_shiftright_impl(vector_int32_t& dst,

...
__aicore__ inline void asc_and_impl(__ubuf__ int16_t* dst, __ubuf__ int16_t* src0, __ubuf__ int16_t* src1,
...
{
    if ASC_IS_AIV {
        vand(dst, src0, src1, repeat, dst_block_stride, src0_block_stride, src1_block_stride, dst_repeat_stride,
                                    ...
                                    uint32_t count)
{
    ...
    asc_and_impl(dst, src0, src1, ASC_C_API_DEFAULT_REPEAT.U8, ASC_C_API_DEFAULT_BLOCK_STRIDE.U8,
...
__aicore__ inline void asc_and_sync_impl(__ubuf__ int16_t* dst, __ubuf__ int16_t* src0, __ubuf__ int16_t* src1,
                                     uint32_t count)
{
...
__aicore__ inline void asc_and_impl(__ubuf__ uint16_t* dst, __ubuf__ uint16_t* src0, __ubuf__ uint16_t* src1,
                                    uint8_t repeat, uint8_t dst_block_stride, uint8_t src0_block_stride,
                                    uint8_t src1_block_stride, uint8_t dst_repeat_stride, uint8_t src0_repeat_stride,
                                    uint8_t src1_repeat_stride)
{
...
__aicore__ inline void asc_and_sync_impl(__ubuf__ uint16_t* dst, __ubuf__ uint16_t* src0, __ubuf__ uint16_t* src1,
                                     uint32_t count)
{
    asc_and_impl(dst, src0, src1, count);
    asc_sync_post_process();

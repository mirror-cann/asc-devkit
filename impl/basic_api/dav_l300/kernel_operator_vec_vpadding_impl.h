...
#pragma message( \
    "impl/basic_api/dav_l300/kernel_operator_vec_vpadding_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_vec_intf.h\"\" and use public functions or variables defined in interface headers files.")
...
__aicore__ inline void VectorPaddingImpl(
    __ubuf__ T* dst, __ubuf__ T* src, uint8_t padMode, bool padSide, const uint64_t mask, uint8_t repeatTimes,
...
template <typename T, bool isSetMask>
__aicore__ inline void VectorPaddingImpl(
    __ubuf__ T* dst, __ubuf__ T* src, uint8_t padMode, bool padSide, const uint64_t mask[2], uint8_t repeatTimes,
    const UnaryRepeatParams& repeatParams)
{
    ASCENDC_ASSERT((false), "VectorPadding is not supported");
}

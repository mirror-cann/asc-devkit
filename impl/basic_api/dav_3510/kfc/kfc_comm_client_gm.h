...
#pragma message( \
    "impl/basic_api/dav_3510/kfc/kfc_comm_client_gm.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_operator_intf.h\"\" and use public functions or variables defined in interface headers files.")
    ...
    __aicore__ inline KfcCommClient(GM_ADDR workspace, int subBlockID, uint8_t enableHardWare = 0)
    {
        if ASCEND_IS_AIV {
            ...
            ubMsg = reinterpret_cast<__ubuf__ KfcMsg*>(
                GetTPipePtr()->GetBaseAddr((int8_t)TPosition::VECIN) + TOTAL_UB_SIZE + 2 * 1024 - sizeof(KfcMsg));
#else

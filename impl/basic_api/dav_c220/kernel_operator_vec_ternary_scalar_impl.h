...
#pragma message( \
    "impl/basic_api/dav_c220/kernel_operator_vec_ternary_scalar_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_vec_intf.h\"\" and use public functions or variables defined in interface headers files.")
    ...
    __ubuf__ T* dst, __ubuf__ U* src, U scalarValue, const uint8_t repeatTime, const UnaryRepeatParams& repeatParams)
{
    ASCENDC_DEBUG_ASSERT(
        ...
        KERNEL_LOG_INTERNAL(
            KERNEL_ERROR, "Failed to check dtype in Axpy, current api support dtype combination is src: "

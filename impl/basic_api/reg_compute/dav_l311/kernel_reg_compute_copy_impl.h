...
__simd_callee__ inline void CopyImpl(RegT& dstReg, RegT& srcReg, MaskReg mask)
{
    ...
    static_assert(SupportEnum<mode, MaskMergeMode::MERGING>(), "current Move api only supported MaskMergeMode MERGING");

...
| [01_matrix_compute](./01_matrix_compute) | This sample directory uses operators such as batch_matmul and as examples to demonstrate the usage of matrix computation interfaces.|

...
| [03_matrix_compute](./03_matrix_compute) | This sample directory uses operators such as batch_matmul and fixpipe_co12c1_quantization as examples to demonstrate the usage of matrix computation interfaces.|

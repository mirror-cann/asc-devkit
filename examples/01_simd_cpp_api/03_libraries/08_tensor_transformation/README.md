...
| [transdata](./transdata) |  本样例演示了基于TransData高阶API实现的算子实现。样例将输入数据的排布格式转换为目标排布格式 | Ascend 950PR/Ascend 950DT<br>Atlas A3 训练系列产品/Atlas A3 推理系列产品<br>Atlas A2 训练系列产品/Atlas A2 推理系列产品 |

...
|  目录名称                                                   |  功能描述                                              |
| ------------------------------------------------------------ | ---------------------------------------------------- |
| [00_vector_compute](./00_vector_compute) | 基于Vector Compute API使用的优化样例，通过<<<>>>直调的实现方式，介绍基于静态Tensor方式编程的性能调优方法。 |
| [01_matrix_compute](./01_matrix_compute) | 基于Matrix Compute API使用的优化样例，介绍Matmul算子的性能调优方法。 |

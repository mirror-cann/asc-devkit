...
| [sigmoid](./sigmoid) |  本样例演示了基于Sigmoid高阶API实现的算子。样例按元素做逻辑回归Sigmoid | Ascend 950PR/Ascend 950DT<br>Atlas A3 训练系列产品/Atlas A3 推理系列产品<br>Atlas A2 训练系列产品/Atlas A2 推理系列产品 |

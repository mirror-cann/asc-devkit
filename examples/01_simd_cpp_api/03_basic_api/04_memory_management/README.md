...
本路径下包含了与资源管理相关的多个API的样例。每个样例均基于Ascend C的<<<>>>直调方法，支持main函数和kernel函数在同一个.asc文件中实现。
...
| [tensor_allocation](./tensor_allocation) |  本样例介绍GlobalTensor、LocalTensor、RegTensor的申请与使用方式。 | Ascend 950PR/Ascend 950DT<br>Atlas A3 训练系列产品/Atlas A3 推理系列产品<br>Atlas A2 训练系列产品/Atlas A2 推理系列产品 |

...
本样例展示了如何利用 Ascend C 的SIMT的[`asc_atomic_add()`](https://gitcode.com/cann/asc-devkit/blob/master/docs/zh/api/SIMT-API/原子操作/asc_atomic_add.md)接口，高效统计输入字节序列中每个字节值的出现频率。功能示意如下图：<br>

...
CASE_REL=01_simd_cpp_api/04_advanced_api/03_quantization/antiquant
...
case_build() {
    ...
    (cd "$BUILD_DIR" && soc_version=$SOC_VERSION bash -lc 'python3 ../scripts/gen_data.py -DCMAKE_ASC_ARCHITECTURES=dav-2201')
}

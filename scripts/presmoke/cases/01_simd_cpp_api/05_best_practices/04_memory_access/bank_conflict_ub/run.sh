...
CASE_REL=01_simd_cpp_api/05_best_practices/04_memory_access/bank_conflict_ub
...
case_build() {
    ...
    (cd "$BUILD_DIR" && SCENARIO_NUM=1 soc_version=$SOC_VERSION bash -lc 'python3 ../scripts/gen_data.py --scenario $SCENARIO_NUM')
}

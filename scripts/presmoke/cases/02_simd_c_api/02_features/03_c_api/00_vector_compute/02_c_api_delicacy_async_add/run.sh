...
CASE_REL=02_simd_c_api/02_features/03_c_api/00_vector_compute/02_c_api_delicacy_async_add
...
case_run() {
    mkdir -p "$BUILD_DIR"
    (cd "$BUILD_DIR" && soc_version=$SOC_VERSION bash -lc ./c_api_add_example)
}

#!/bin/sh
# Perform upgrade for asc-devkit package
# ----------------------------------------------------------------------------------------------------------
...
output_progress() {
    new_echo "INFO" "asc-devkit upgrade upgradePercentage:$1%"
    log "INFO" "asc-devkit upgrade upgradePercentage:$1%"
}
...
##########################################################################
log "INFO" "step into run_asc-devkit_upgrade.sh ......"
